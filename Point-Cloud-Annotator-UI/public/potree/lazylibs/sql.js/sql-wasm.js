...
var initSqlJs = function (moduleConfig) {
  ...
  initSqlJsPromise = new Promise((resolveModule, reject) => {
    ...
    var va = function () {
      ...
      var d = (function () {
        ...
        a.prototype.getBlob = function (a) {
          ...
          for (a = b = 0; 0 <= c ? b < c : b > c; a = 0 <= c ? ++b : --b) e[a] = l[d + a];
          return e;
        };
        a.prototype.get = function (a) {
          ...
          var e = [];
          a = b = 0;
          for (d = ib(this.fb); 0 <= d ? b < d : b > d; a = 0 <= d ? ++b : --b)
            switch (Yb(this.fb, a)) {
              case c.fc:
              case c.FLOAT:
                e.push(this.sc(a));
        ...
        a.prototype.getColumnNames = function () {
          ...
          var c = [];
          var d = (a = 0);
          for (b = ib(this.fb); 0 <= b ? a < b : a > b; d = 0 <= b ? ++a : --a)
            c.push(Zb(this.fb, d));
          return c;
        };
        ...
        a.prototype.oc = function (a, b) {
          null == b && (b = this.nb++);
          this.db.handleError((a === (a | 0) ? $b : ac)(this.fb, b, a));
        };
        ...
        a.prototype.Qb = function (a, b) {
          ...
          switch (typeof a) {
            ...
            case 'object':
              ...
              else throw 'Wrong API use : tried to bind a value of an unknown type (' + a + ').';
          }
        };
      ...
      var e = (function () {
        function a(a) {
          ...
          if (null != a) {
            ...
            if (a) {
              if ('string' === typeof a) {
                for (var e = Array(a.length), k = 0, m = a.length; k < m; ++k)
                  e[k] = a.charCodeAt(k);
                a = e;
              }
              ka(d, c | 146);
        ...
        a.prototype.exec = function (a) {
          ...
          for (g = []; q(a, 'i8') !== da; ) {
            ...
            if (k !== da) {
              var m = new d(k, this);
              for (k = null; m.step(); )
                (null === k && ((k = { columns: m.getColumnNames(), values: [] }), g.push(k)),
                  k.values.push(m.get()));
              m.free();
            }
          }
        ...
        a.prototype['export'] = function () {
          ...
          sa(c, m, 0, d, 0);
          'utf8' === e.encoding ? (a = t(m, 0)) : 'binary' === e.encoding && (a = m);
          ma(c);
          this.handleError(g(this.filename, b));
          this.db = q(b, 'i32');
          return a;
        ...
        a.prototype.create_function = function (a, b) {
          var d = ua(function (a, c, d) {
            var e, g;
            var k = [];
            for (e = g = 0; 0 <= c ? g < c : g > c; e = 0 <= c ? ++g : --g) {
              var m = q(d + 4 * e, 'i32');
              var z = jc(m);
              e = (function () {
                switch (!1) {
                  ...
                  case 4 !== z:
                    return function (a) {
                      ...
                      var e = oc(a);
                      a = new Uint8Array(d);
                      for (b = c = 0; 0 <= d ? c < d : c > d; b = 0 <= d ? ++c : --c)
                        a[b] = l[e + b];
                      return a;
                    };
                  default:
          ...
          this.handleError(sc(this.db, a, b.length, c.jc, 0, d, 0, 0, 0));
          return this;
        };
        return a;
      })();
      ...
      var m = f.cwrap('sqlite3_exec', 'number', ['number', 'string', 'number', 'number', 'number']);
      ...
      var ac = f.cwrap('sqlite3_bind_double', 'number', ['number', 'number', 'number']);
      var $b = f.cwrap('sqlite3_bind_int', 'number', ['number', 'number', 'number']);
      var bc = f.cwrap('sqlite3_bind_parameter_index', 'number', ['number', 'string']);
      ...
      var Ub = f.cwrap('sqlite3_column_double', 'number', ['number', 'number']);
      var Vb = f.cwrap('sqlite3_column_text', 'string', ['number', 'number']);
      var Xb = f.cwrap('sqlite3_column_blob', 'number', ['number', 'number']);
      var Wb = f.cwrap('sqlite3_column_bytes', 'number', ['number', 'number']);
      var Yb = f.cwrap('sqlite3_column_type', 'number', ['number', 'number']);
      var Zb = f.cwrap('sqlite3_column_name', 'string', ['number', 'number']);
      ...
      var qc = f.cwrap('sqlite3_result_text', '', ['number', 'string', 'number', 'number']);
      var fc = f.cwrap('RegisterExtensionFunctions', 'number', ['number']);
      this.SQL = { Database: e };
    ...
    x = 'object' === typeof process && 'function' === typeof require && !v && !w;
    xa = !v && !x && !w;
    var A = '';
    if (x) {
      A = __dirname + '/';
      ...
      ('undefined' != typeof read &&
        ...
        'undefined' != typeof scriptArgs
          ...
          : 'undefined' != typeof arguments && (f.arguments = arguments),
        'function' === typeof quit &&
          (f.quit = function (a) {
            quit(a);
          }));
    else if (v || w)
      (w ? (A = self.location.href) : document.currentScript && (A = document.currentScript.src),
    ...
    var Aa =
      ...
      C =
        ...
        ('undefined' !== typeof printErr
          ? printErr
          : ('undefined' !== typeof console && console.warn.bind(console)) || Aa);
    ...
    5242880 > Ya &&
      C('TOTAL_MEMORY should be larger than TOTAL_STACK, was ' + Ya + '! (TOTAL_STACK=5242880)');
    f.buffer
      ? (buffer = f.buffer)
      : 'object' === typeof WebAssembly && 'function' === typeof WebAssembly.Memory
        ? ((La = new WebAssembly.Memory({ initial: Ya / 65536 })), (buffer = La.buffer))
    ...
    function mb(a) {
      function b(a) {
        ...
        0 == H &&
          (null !== fb && (clearInterval(fb), (fb = null)), gb && ((a = gb), (gb = null), a()));
      }
      function c(a) {
        b(a.instance);
      }
      ...
      'function' !== typeof fetch
        ? d(c)
        : WebAssembly.instantiateStreaming(fetch(I, { credentials: 'same-origin' }), e).then(
            c,
            function (a) {
    ...
    f.asm = function (a, b) {
      b.memory = La;
      b.table = new WebAssembly.Table({ initial: 2560, maximum: 2560, element: 'anyfunc' });
    ...
    function ob(a) {
      ...
      for (e = 0; e < a.length; e++) {
        d = g = a[e];
        for (var k = c, m = 0; m < d.length; ++m) l[k++ >> 0] = d.charCodeAt(m);
        l[k >> 0] = 0;
        D[(b + 4 * e) >> 2] = c;
        c += g.length + 1;
      }
    ...
    var zb = {
        ...
        write: function (a, b, c, d) {
          ...
          try {
            for (var e = 0; e < d; e++) a.tty.ub.Ib(a.tty, b[c + e]);
          } catch (g) {
            throw new K(L.Lb);
          }
      ...
      Ab = {
        ...
        flush: function (a) {
          a.output && 0 < a.output.length && (Aa(t(a.output, 0)), (a.output = []));
        },
      },
      Bb = {
        Ib: function (a, b) {
        ...
        flush: function (a) {
          a.output && 0 < a.output.length && (C(t(a.output, 0)), (a.output = []));
        },
      },
      M = {
        mb: null,
        ...
        createNode: function (a, b, c, d) {
          if (24576 === (c & 61440) || 4096 === (c & 61440)) throw new K(L.dc);
          M.mb ||
            (M.mb = {
              dir: {
                node: {
              ...
              link: { node: { lb: M.ab.lb, hb: M.ab.hb, readlink: M.ab.readlink }, stream: {} },
              Sb: { node: { lb: M.ab.lb, hb: M.ab.hb }, stream: Cb },
            });
          c = Db(a, b, c, d);
          N(c.mode)
            ? ((c.ab = M.mb.dir.node), (c.cb = M.mb.dir.stream), (c.bb = {}))
            : 32768 === (c.mode & 61440)
              ? ((c.ab = M.mb.file.node), (c.cb = M.mb.file.stream), (c.gb = 0), (c.bb = null))
              : 40960 === (c.mode & 61440)
                ? ((c.ab = M.mb.link.node), (c.cb = M.mb.link.stream))
                : 8192 === (c.mode & 61440) && ((c.ab = M.mb.Sb.node), (c.cb = M.mb.Sb.stream));
        ...
        yc: function (a, b) {
          if (a.gb != b)
            if (0 == b) ((a.bb = null), (a.gb = 0));
              ...
              } else if ((a.bb || (a.bb = []), a.bb.length > b)) a.bb.length = b;
        ...
        cb: {
          ...
          write: function (a, b, c, d, e, g) {
            ...
            if (b.subarray && (!a.bb || a.bb.subarray)) {
              if (g) return ((a.bb = b.subarray(c, c + d)), (a.gb = d));
              if (0 === a.gb && 0 === e)
                return ((a.bb = new Uint8Array(b.subarray(c, c + d))), (a.gb = d));
              if (e + d <= a.gb) return (a.bb.set(b.subarray(c, c + d), e), d);
            }
            M.Tb(a, e + d);
          ...
          ob: function (a, b, c) {
            1 === c
              ? (b += a.position)
              : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.gb);
      ...
      P = {
        ...
        createNode: function (a, b, c) {
          if (!N(c) && 32768 !== (c & 61440) && 40960 !== (c & 61440)) throw new K(L.ib);
          a = Db(a, b, c);
          a.ab = P.ab;
          a.cb = P.cb;
          return a;
        ...
        ab: {
          lb: function (a) {
            ...
            P.yb && !b.pb && (b.pb = 4096);
            P.yb && !b.blocks && (b.blocks = ((b.size + b.pb - 1) / b.pb) | 0);
            return {
              dev: b.dev,
              ino: b.ino,
              mode: b.mode,
          ...
          vb: function (a, b, c, d) {
            ...
            b = P.kb(a);
            try {
              N(a.mode) ? fs.mkdirSync(b, a.mode) : fs.writeFileSync(b, '', { mode: a.mode });
            } catch (e) {
              if (!e.code) throw e;
          ...
          readlink: function (a) {
            var b = P.kb(a);
            try {
              return ((b = fs.readlinkSync(b)), (b = Fb.relative(Fb.resolve(a.jb.Hb.root), b)));
            } catch (c) {
              if (!c.code) throw c;
              throw new K(L[c.code]);
            }
        ...
        cb: {
          open: function (a) {
            var b = P.kb(a.node);
            try {
              32768 === (a.node.mode & 61440) && (a.wb = fs.openSync(b, P.qc(a.flags)));
            } catch (c) {
              if (!c.code) throw c;
              throw new K(L[c.code]);
            }
          ...
          close: function (a) {
            try {
              32768 === (a.node.mode & 61440) && a.wb && fs.closeSync(a.wb);
            } catch (b) {
              if (!b.code) throw b;
              throw new K(L[b.code]);
            }
      ...
      for (d = 0; d < a.length; d++) {
        ...
        if (!g || b.qb)
          for (g = 0; 40960 === (e.mode & 61440); )
            if (((e = Kb(c)), (c = vb(sb(c), e)), (e = T(c, { Jb: b.Jb }).node), 40 < g++))
              throw new K(40);
      }
    ...
    function Lb(a) {
      for (var b; ; ) {
        if (a === a.parent)
          return ((a = a.jb.Yb), b ? ('/' !== a[a.length - 1] ? a + '/' + b : a + b) : a);
        b = b ? a.name + '/' + b : a.name;
        a = a.parent;
      }
    }
    ...
    function O(a, b) {
      var c;
      if ((c = (c = Pb(a, 'x')) ? c : a.ab.lookup ? 0 : 13)) throw new K(c, a);
    ...
    function ta(a) {
      ...
      try {
        ...
        console.log(
          "FS.trackingDelegate['onDeletePath']('" + a + "') threw an exception: " + g.message,
        );
      }
    }
    function Kb(a) {
    ...
    function ka(a, b) {
      ...
      c.ab.hb(c, { mode: (b & 4095) | (c.mode & -4096), timestamp: Date.now() });
    }
    function Cc(a) {
      var b;
    ...
    function p(a, b, c, d) {
      ...
      b &= -641;
      d = wc(
        { node: g, path: Lb(g), flags: b, seekable: !0, position: 0, cb: g.cb, Bc: [], error: !1 },
        d,
      );
      ...
      !f.logReadFiles ||
        b & 1 ||
        (Ec || (Ec = {}),
        a in Ec || ((Ec[a] = 1), console.log('FS.trackingDelegate error on read file: ' + a)));
      try {
        S.onOpenFile &&
          ((g = 0),
          1 !== (b & 2097155) && (g |= 1),
        ...
        console.log(
          "FS.trackingDelegate['onOpenFile']('" + a + "', flags) threw an exception: " + k.message,
        );
      }
      return d;
    }
    ...
    function la(a, b, c, d, e, g) {
      ...
      try {
        ...
        console.log(
          "FS.trackingDelegate['onWriteToFile']('" + a.path + "') threw an exception: " + m.message,
        );
      }
      return b;
    }
    function Gc() {
      K ||
        ((K = function (a, b) {
          ...
          this.stack &&
            Object.defineProperty(this, 'stack', { value: Error().stack, writable: !0 });
        }),
        (K.prototype = Error()),
    ...
    function Ea(a) {
      ...
      for (var b = Math.max(Da(), 16777216); b < a; )
        536870912 >= b ? (b = Wa(2 * b)) : (b = Math.min(Wa((3 * b + 2147483648) / 4), 2147418112));
      a = Wa(b);
      var c = buffer.byteLength;
      try {
        var d = -1 !== La.grow((a - c) / 65536) ? (buffer = La.buffer) : null;
      } catch (e) {
        d = null;
      }
    ...
    function Nc() {
      ...
      if (!Oc) {
        ...
        var b = new Date(2e3, 0, 1),
          c = new Date(2e3, 6, 1);
        D[Qc() >> 2] = Number(b.getTimezoneOffset() != c.getTimezoneOffset());
        var d = a(b),
          e = a(c);
        d = ea(ba(d));
        e = ea(ba(e));
      ...
      {},
      {
        ...
        m: function (a, b, c, d) {
          B(
            'Assertion failed: ' +
              G(a) +
              ', at: ' +
              [b ? G(b) : 'unknown filename', c, d ? G(d) : 'unknown function'],
          );
        },
        ga: ob,
        u: pb,
        fa: function (a, b) {
          ...
          try {
            ...
            return (('undefined' !== typeof V && d instanceof K) || B(d), -d.eb);
          }
        },
        ea: function (a, b) {
          W = b;
          try {
            ...
            return (('undefined' !== typeof V && c instanceof K) || B(c), -c.eb);
          }
        },
        da: function (a, b) {
          W = b;
          try {
            ...
            return (('undefined' !== typeof V && k instanceof K) || B(k), -k.eb);
          }
        },
        ca: function (a, b) {
          W = b;
          try {
            ...
            return (('undefined' !== typeof V && e instanceof K) || B(e), -e.eb);
          }
        },
        ba: function (a, b) {
          W = b;
        ...
        aa: function (a, b) {
          ...
          try {
            ...
            return (('undefined' !== typeof V && ca instanceof K) || B(ca), -ca.eb);
          }
        },
        $: function (a, b) {
          W = b;
          try {
            ...
            return (('undefined' !== typeof V && g instanceof K) || B(g), -g.eb);
          }
        },
        t: function (a, b) {
          W = b;
        ...
        o: function (a, b) {
          ...
          try {
            ...
            switch (X()) {
              case 0:
                var d = X();
                return 0 > d ? -L.ib : p(c.path, c.flags, 0, d).fd;
              case 1:
              case 2:
                return 0;
              case 3:
        ...
        Q: function (a, b) {
          ...
          try {
            ...
            try {
              ...
              console.log(
                "FS.trackingDelegate['onDeletePath']('" + c + "') threw an exception: " + m.message,
              );
            }
            return 0;
          } catch (m) {
            return (('undefined' !== typeof V && m instanceof K) || B(m), -m.eb);
          }
        },
        P: function (a, b) {
          W = b;
        ...
        O: function (a, b) {
          ...
          try {
            ...
            return (('undefined' !== typeof V && z instanceof K) || B(z), -z.eb);
          }
        },
        N: function (a, b) {
          W = b;
          try {
            ...
            return (('undefined' !== typeof V && y instanceof K) || B(y), -y.eb);
          }
        },
        M: function (a, b) {
          W = b;
    ...
    function Yc() {
        ...
        if (!f.calledRun && ((f.calledRun = !0), !Ma)) {
          db ||
            ...
            f.noFSInit ||
              ...
              (f.stdout = f.stdout),
              (f.stderr = f.stderr),
              f.stdin ? Ic('stdin', f.stdin) : Ac('/dev/tty', '/dev/stdin'),
              f.stdout ? Ic('stdout', null, f.stdout) : Ac('/dev/tty', '/dev/stdout'),
              f.stderr ? Ic('stderr', null, f.stderr) : Ac('/dev/tty1', '/dev/stderr'),
              p('/dev/stdin', 'r'),
              p('/dev/stdout', 'w'),
              p('/dev/stderr', 'w')),
            Za(ab));
      ...
      if (!(0 < H)) {
        if (f.preRun)
          for ('function' == typeof f.preRun && (f.preRun = [f.preRun]); f.preRun.length; ) eb();
        Za($a);
        0 < H ||
          f.calledRun ||
          (f.setStatus
