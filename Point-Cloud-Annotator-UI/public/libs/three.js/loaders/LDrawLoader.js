    ...
    getMaterial: function (colourCode) {
      ...
      if (colourCode.startsWith('0x2')) {
        ...
        return this.parseColourMetaDirective(
          new LineParser(
            'Direct_Color_' + colour + ' CODE -1 VALUE #' + colour + ' EDGE #' + colour + '',
          ),
        );
      }
    ...
    objectParse: function (text) {
      ...
      for (lineIndex = 0; lineIndex < numLines; lineIndex++) {
        ...
        switch (lineType) {
                ...
                case 'BFC':
                  ...
                  while (!lp.isAtTheEnd()) {
                    ...
                    switch (token) {
                      ...
                      default:
                        console.warn(
                          'THREE.LDrawLoader: BFC directive "' + token + '" is unknown.',
                        );
          ...
          default:
            throw (
              'LDrawLoader: Unknown line type "' + lineType + '"' + lp.getLineNumberString() + '.'
            );
            break;
        }
      }
      ...
      function loadSubobject(subobject) {
        ...
        switch (subobject.locationState) {
          ...
          case LDrawLoader.FILE_LOCATION_NOT_FOUND:
            ...
            console.warn(
              'LDrawLoader: Subobject "' + subobject.originalFileName + '" could not be found.',
            );
