...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function S(t, e, n) {
        for (
          var r = Array.isArray(t), a = r ? t : o(t), s = r ? [] : i(t), u = n, c = 0;
          c < a.length;
          c++
        )
    ...
    function (t, e, n) {
      ...
      function T(t) {
        ...
        if (t instanceof d)
          return { type: 'Repetition', name: t.name, idx: t.idx, definition: e(t.definition) };
        if (t instanceof m)
          return { type: 'Alternation', name: t.name, idx: t.idx, definition: e(t.definition) };
        if (t instanceof y) {
          var n = {
              type: 'Terminal',
          ...
          buildDuplicateFoundError: function (t, e) {
            var n,
              ...
              h =
                ...
                '<-.\n                  ' +
                (0 === c
                  ? 'Also note that numerical suffix 0 means ' + p + ' without any suffix.'
                  : '') +
          ...
          for (; r.length < n && o < e.length; ) {
            ...
            if (u instanceof c.Option) i = s(u.definition);
              ...
              if (u instanceof c.RepetitionMandatory)
                return s(
                  (p = u.definition.concat([new c.Repetition({ definition: u.definition })])),
                );
              if (u instanceof c.RepetitionMandatoryWithSeparator)
                return s(
                  (p = [
                    ...
                    new c.Repetition({
                      definition: [new c.Terminal({ terminalType: u.separator })].concat(
                        u.definition,
                      ),
                    }),
                  ]),
                ...
                if ('EXIT_NONE_TERMINAL' === T) {
                  ...
                  if (d < s - 1) {
                    ...
                    n(e[g], T.terminalType) &&
                      ((v = { idx: g, def: a.drop(f), ruleStack: E, occurrenceStack: m }),
                      l.push(v));
                  } else {
                  ...
                  var A = { idx: d, def: a.drop(f), ruleStack: E, occurrenceStack: m };
                  ...
                  var O = new c.Repetition({ definition: T.definition, idx: T.idx });
                  ((v = {
                    idx: d,
                  ...
                  ((O = new c.Repetition({ definition: [S].concat(T.definition), idx: T.idx })),
                    (v = {
                      idx: d,
                      def: T.definition.concat([O], a.drop(f)),
                      ruleStack: E,
                  ...
                  ((A = { idx: d, def: a.drop(f), ruleStack: E, occurrenceStack: m }),
                    l.push(A),
                    l.push('EXIT_ALTERNATIVE'),
                    (S = new c.Terminal({ terminalType: T.separator })));
                  var I = new c.Repetition({ definition: [S].concat(T.definition), idx: T.idx });
                  ((N = {
                    idx: d,
                    def: T.definition.concat([I], a.drop(f)),
                    ruleStack: E,
                  ...
                  ((A = { idx: d, def: a.drop(f), ruleStack: E, occurrenceStack: m }),
                    l.push(A),
                    l.push('EXIT_ALTERNATIVE'),
                    (I = new c.Repetition({ definition: T.definition, idx: T.idx })),
                    (N = {
                      idx: d,
                      def: T.definition.concat([I], a.drop(f)),
                      ruleStack: E,
            ...
            for (w.call(this, e); v < T; ) {
              ...
              if (null !== u) {
                ...
                ((f = v - X),
                  ...
                  A.push({ offset: X, line: z, column: q, length: f, message: d }));
              }
            }
        ...
        (e.validatePatterns = function (t, e) {
          ...
          return (n = (n = (n = (n = (n = n.concat(i.errors)).concat(
            (function (t) {
              ...
              return (e = (e = (e = (e = (e = e.concat(E(n))).concat(T(n))).concat(v(n))).concat(
                g(n),
              )).concat(m(n)));
            })(o),
        ...
        (e.LineTerminatorOptimizedTester = {
          test: function (t) {
            for (var e = t.length, n = this.lastIndex; n < e; n++) {
              ...
              if (13 === r)
                return (
                  10 === t.charCodeAt(n + 1) ? (this.lastIndex = n + 2) : (this.lastIndex = n + 1),
                  !0
                );
            }
            return !1;
        ...
        p = (function () {
          ...
          return (
            ...
            (t.prototype.RULE = function (t, e, n) {
              if (
                (void 0 === n && (n = o.DEFAULT_RULE_CONFIG), r.contains(this.definedRulesNames, t))
              ) {
                var i = {
              ...
              if (
                ...
                !this.gastProductionsCache.containsKey(t) && !this.serializedGrammar)
              ) {
            ...
            (t.prototype.OVERRIDE_RULE = function (t, e, n) {
              ...
              if (
                ((r = r.concat(
                  u.validateRuleIsOverridden(t, this.definedRulesNames, this.className),
                )),
        ...
        f = (function () {
          ...
          return (
                          ...
                          if (r) {
                            ...
                            if (this.isInCurrentRuleReSyncSet(a))
                              return (
                                ...
                                this.outputCst
                                  ? (((i =
                                      this.CST_STACK[this.CST_STACK.length - 1]).recoveredNode =
                                      !0),
                                    i)
                                  : c()
                              );
                            throw (
                              this.outputCst &&
                                (((i = this.CST_STACK[this.CST_STACK.length - 1]).recoveredNode =
                                  !0),
            ...
            (t.prototype.manyInternalLogic = function (t, e, n) {
              ...
              for (var p = !0; !0 === u.call(this) && !0 === p; ) p = this.doSingleRepetition(r);
              this.attemptInRepetitionRecovery(
                this.manyInternal,
                [t, e],
                u,
            ...
            (t.prototype.consumeInternal = function (t, e, n) {
              ...
              return (
                this.cstPostTerminal(void 0 !== n && void 0 !== n.LABEL ? n.LABEL : t.tokenName, r),
                r
              );
            }),
    ...
    function (t, e, n) {
      ...
      e.createSyntaxDiagramsCode = function (t, e) {
        ...
        return (
          ...
          (void 0 === a
            ? 'https://unpkg.com/chevrotain@' + r.VERSION + '/diagrams/diagrams.css'
            : a) +
          "'>\n\n<script src='" +
          o +
        ...
        return (
          e.name || e.separator
            ? ((r += '{' + a),
              ...
              e.separator &&
                (r += y(n + 1, 'SEP: this.tokensMap.' + i.tokenName(e.separator)) + ',' + a),
