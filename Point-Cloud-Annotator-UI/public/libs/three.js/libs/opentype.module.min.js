  ...
  return (function e(t, n, r) {
  ...
  })(
    {
        ...
        function (require, module, exports) {
          ...
          function tinf_decode_symbol(e, t) {
            ...
            var n = 0,
              ...
              s = 0,
              i = e.tag;
            do ((r = 2 * r + (1 & i)), (i >>>= 1), ++s, (n += t.table[s]), (r -= t.table[s]));
            while (r >= 0);
                ...
                for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++)
                  this.names[l] =
                    e.glyphNameIndex[l] < exports.standardNames.length
                      ...
                      : e.names[e.glyphNameIndex[l] - exports.standardNames.length];
                break;
              case 2.5:
                for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++)
            ...
            for (s = 0; s < e.glyphs.length; s += 1)
              ((l = e.glyphs.get(s)),
                e.cffEncoding
                  ...
                  : e.glyphNames.names && (l.name = e.glyphNames.glyphIndexToName(s)));
          }
          ...
          function Font(e) {
            ((e = e || {}),
              e.empty ||
                ...
                util.checkArgument(e.descender < 0, 'Descender should be negative (e.g. -512).'),
                (this.names = {
        ...
        function (require, module, exports) {
          ...
          ((Glyph.prototype.bindConstructorValues = function (t) {
            ((this.index = t.index || 0),
              ...
              Object.defineProperty(this, 'path', getPathDefinition(this, t.path)));
          }),
              ...
              for (
                ...
                'M' === y.type
                  ...
                  : 'L' === y.type
                    ...
                    : 'Q' === y.type
                      ? r.quadraticCurveTo(t + y.x1 * h, i + -y.y1 * o, t + y.x * h, i + -y.y * o)
                      : 'C' === y.type
                        ? r.curveTo(
                            t + y.x1 * h,
                            i + -y.y1 * o,
            ...
            (Glyph.prototype.getMetrics = function () {
              for (var t = this.path.commands, i = [], e = [], n = 0; n < t.length; n += 1) {
                ...
                ('Z' !== a.type && (i.push(a.x), e.push(a.y)),
                  ('Q' === a.type || 'C' === a.type) && (i.push(a.x1), e.push(a.y1)),
              ...
              return (
                ...
                (h.rightSideBearing = this.advanceWidth - h.leftSideBearing - (h.xMax - h.xMin)),
                h
              );
            }),
            ...
            (Glyph.prototype.drawPoints = function (t, i, e, n) {
              ...
              for (
                var h = (1 / this.path.unitsPerEm) * n, o = [], r = [], s = this.path, p = 0;
                p < s.commands.length;
                p += 1
              ) {
                var y = s.commands[p];
          ...
          var check = require('./check'),
            Layout = {
              ...
              getFeatureTable: function (e, r, t, a) {
                ...
                if (s) {
                  for (
                    var n, u = s.featureIndexes, i = this.font.tables.gsub.features, g = 0;
                    g < u.length;
                    g++
                  )
                  ...
                  if (a) {
                    ...
                    return (
                      ...
                      (n = { tag: t, feature: { params: 0, lookupListIndexes: [] } }),
                      i.push(n),
                      u.push(o),
                      n.feature
                    );
              ...
              getLookupTable: function (e, r, t, a, s) {
                ...
                if (n) {
                  for (
                    var u, i = n.lookupListIndexes, g = this.font.tables.gsub.lookups, o = 0;
                    o < i.length;
                    o++
                  )
      ...
      9: [
        function (require, module, exports) {
          ...
          function parseBuffer(e) {
            ...
            if (
              (hmtx.parse(L.data, L.offset, t.numberOfHMetrics, t.numGlyphs, t.glyphs),
          ...
          ((Parser.prototype.parseByte = function () {
            ...
            (Parser.prototype.parseOffset16List = Parser.prototype.parseUShortList =
              function (t) {
                ...
                for (
                  var r = new Array(t), e = this.data, s = this.offset + this.relativeOffset, a = 0;
                  t > a;
                  a++
                )
              ...
              for (
                ...
                if (0 !== i)
                  if (((this.relativeOffset = i), t)) {
                    for (
                      var n = this.parseOffset16List(), f = new Array(n.length), p = 0;
                      p < n.length;
                      p++
                    )
          ...
          ((Path.prototype.moveTo = function (t, o) {
            ...
            (Path.prototype.draw = function (t) {
              ...
              (this.fill && ((t.fillStyle = this.fill), t.fill()),
                this.stroke &&
                  ((t.strokeStyle = this.stroke), (t.lineWidth = this.strokeWidth), t.stroke()));
            }),
            ...
            (Path.prototype.toSVG = function (t) {
              ...
              return (
                ...
                this.fill &&
                  'black' !== this.fill &&
                  (o += null === this.fill ? ' fill="none"' : ' fill="' + this.fill + '"'),
                this.stroke &&
                  (o += ' stroke="' + this.stroke + '" stroke-width="' + this.strokeWidth + '"'),
                (o += '/>')
              );
            }),
            (exports.Path = Path));
        ...
        function (require, module, exports) {
          ...
          ((Substitution.prototype = Layout),
            ...
            (Substitution.prototype.getAlternates = function (t, e, r) {
              ...
              for (var o = s.subtables, u = 0; u < o.length; u++)
                for (
                  var i = o[u], n = this.expandCoverage(i.coverage), g = i.alternateSets, l = 0;
                  l < n.length;
                  l++
                )
            ...
            (Substitution.prototype.getLigatures = function (t, e, r) {
              ...
              for (var o = s.subtables, u = 0; u < o.length; u++)
                for (
                  var i = o[u], n = this.expandCoverage(i.coverage), g = i.ligatureSets, l = 0;
                  l < n.length;
                  l++
                )
            ...
            (Substitution.prototype.addSingle = function (t, e, r, a) {
              ...
              (0 > i &&
                ((i = -1 - i), o.coverage.glyphs.splice(i, 0, u), o.substitute.splice(i, 0, 0)),
                (o.substitute[i] = e.by));
            }),
            (Substitution.prototype.addAlternate = function (t, e, r, a) {
              ...
              var u = e.sub,
                i = this.binSearch(o.coverage.glyphs, u);
              (0 > i &&
                ((i = -1 - i), o.coverage.glyphs.splice(i, 0, u), o.alternateSets.splice(i, 0, 0)),
            ...
            Table.call(
              ...
              recordList('scriptRecord', e, function (e, t) {
                ...
                return (
                  check.assert(
                    !!r,
                    'Unable to write GSUB: script ' + e.tag + ' has no default language system.',
                  ),
                  [
              ...
              recordList('featureRecord', e, function (e, t) {
                ...
                return [
                  { name: 'featureTag' + t, type: 'TAG', value: e.tag },
                  {
                    ...
                    value: new Table(
                      'featureTable',
                      [{ name: 'featureParams', type: 'USHORT', value: a.featureParams }].concat(
      ...
      14: [
        function (require, module, exports) {
          ...
          function equals(e, t) {
            ...
            if (Array.isArray(e) && Array.isArray(t)) {
              ...
              for (var a = 0; a < e.length; a += 1) if (!equals(e[a], t[a])) return !1;
              return !0;
            }
            return !1;
          }
          ...
          function parseCFFDict(e, t, a) {
            ...
            for (a = void 0 !== a ? a : e.length; r.relativeOffset < a; ) {
              var i = r.parseByte();
              21 >= i
                ? (12 === i && (i = 1200 + r.parseByte()), n.push([i, s]), (s = []))
              ...
              for (var y, b, C, T, F, I, D, x, k, S, E, O, R = 0; R < a.length; ) {
                ...
                switch (((R += 1), M)) {
                  ...
                  case 3:
                    ...
                    break;
                  case 4:
                    (u.length > 1 && !c && ((d = u.shift() + e.nominalWidthX), (c = !0)),
                      (m += u.pop()),
                      r(v, m));
                    break;
                  case 5:
                  ...
                  case 12:
                    switch (((M = a[R]), (R += 1), M)) {
                      ...
                      case 37:
                        ...
                        break;
                      default:
                        (console.log('Glyph ' + t.index + ': unknown operator 1200' + M),
                          (u.length = 0));
                    }
                    break;
                  case 14:
                    (u.length > 0 && !c && ((d = u.shift() + e.nominalWidthX), (c = !0)),
                      g && (p.closePath(), (g = !1)));
                    break;
                  case 18:
                    n();
                  ...
                  case 20:
                    ...
                    break;
                  case 21:
                    (u.length > 2 && !c && ((d = u.shift() + e.nominalWidthX), (c = !0)),
                      (m += u.pop()),
                      (v += u.pop()),
                      r(v, m));
                    break;
                  ...
                  default:
                    32 > M
                      ? console.log('Glyph ' + t.index + ': unknown operator ' + M)
                      : 247 > M
                        ? u.push(M - 139)
                        : 251 > M
          ...
          function makeTopDict(e, t) {
            var a = new table.Record('Top DICT', [{ name: 'dict', type: 'DICT', value: {} }]);
          ...
          function makeStringIndex(e) {
            ...
            t.strings = [];
            for (var a = 0; a < e.length; a += 1)
              t.strings.push({ name: 'string_' + a, type: 'STRING', value: e[a] });
            return t;
          }
          ...
          function makeCharsets(e, t) {
            for (
              var a = new table.Record('Charsets', [{ name: 'format', type: 'Card8', value: 0 }]),
                r = 0;
              r < e.length;
              r += 1
            ) {
          ...
          function makePrivateDict(e, t) {
            var a = new table.Record('Private DICT', [{ name: 'dict', type: 'DICT', value: {} }]);
        ...
        { '../encoding': 4, '../glyphset': 7, '../parse': 10, '../path': 11, '../table': 13 },
      ],
      15: [
        function (require, module, exports) {
          'use strict';
          function parseCmapTableFormat12(e, a) {
            ...
            for (e.groupCount = t = a.parseULong(), e.glyphIndexMap = {}, r = 0; t > r; r += 1)
              for (
                var n = a.parseULong(), s = a.parseULong(), o = a.parseULong(), l = n;
                s >= l;
                l += 1
              )
          ...
          function makeCmapTable(e) {
            ...
            ((s = r.segments.length),
              (r.segCountX2 = 2 * s),
              (r.searchRange = 2 * Math.pow(2, Math.floor(Math.log(s) / Math.log(2)))),
            ...
            for (a = 0; s > a; a += 1) {
              ...
              ((o = o.concat({ name: 'end_' + a, type: 'USHORT', value: u.end })),
                (l = l.concat({ name: 'start_' + a, type: 'USHORT', value: u.start })),
                (p = p.concat({ name: 'idDelta_' + a, type: 'SHORT', value: u.delta })),
                (g = g.concat({ name: 'idRangeOffset_' + a, type: 'USHORT', value: u.offset })),
                void 0 !== u.glyphId &&
                  (m = m.concat({ name: 'glyph_' + a, type: 'USHORT', value: u.glyphId })));
            }
            return (
              ...
              (r.length =
                14 + 2 * o.length + 2 + 2 * l.length + 2 * p.length + 2 * g.length + 2 * m.length),
              r
            );
          }
          var check = require('../check'),
        ...
        function (require, module, exports) {
          ...
          function makeFvarAxis(e, a, r) {
            ...
            return [
              ...
              { name: 'defaultValue_' + e, type: 'FIXED', value: a.defaultValue << 16 },
      ...
      17: [
        function (require, module, exports) {
          ...
          function getContours(e) {
            ...
            return (
              check.argument(0 === t.length, 'There are still points left in the current contour.'),
              r
            );
          }
          function getPath(e) {
          ...
          function parseGlyfTable(e, r, t, o) {
            ...
            for (a = 0; a < t.length - 1; a += 1) {
              var s = t[a],
                p = t[a + 1];
              s !== p
                ? n.push(a, glyphset.ttfGlyphLoader(o, a, parseGlyph, e, r + s, buildPath))
        ...
        function (require, module, exports) {
          ...
          function parseCoverageTable(r, e) {
            ...
            if (2 === s) {
              for (var o = []; t--; )
                for (
                  var p = a.parseUShort(), n = a.parseUShort(), f = a.parseUShort(), i = p;
                  n >= i;
                  i++
                )
                  o[f++] = i;
          ...
          function parsePairPosSubTable(r, e) {
            ...
            if (4 === f && 0 === i) {
              ...
              if (1 === o) {
                for (
                  var S = t.parseUShort(), u = [], v = t.parseOffset16List(S), U = 0;
                  S > U;
                  U++
                ) {
                  var l = v[U],
          ...
          function parseLookupTable(r, e) {
            var a = new parse.Parser(r, e),
              ...
              f = { lookupType: s, lookupFlag: t, markFilteringSet: o ? a.parseUShort() : -1 };
            if (2 === s) {
          ...
          function parseGposTable(r, e, a) {
            ...
            s.relativeOffset = o;
            for (
              var p = s.parseUShort(), n = s.parseOffset16List(p), f = e + o, i = 0;
              p > i;
              i++
            ) {
        ...
        function (require, module, exports) {
          ...
          function makeGsubTable(e) {
            return new table.Table('GSUB', [
              { name: 'version', type: 'ULONG', value: 65536 },
              { name: 'scripts', type: 'TABLE', value: new table.ScriptList(e.scripts) },
              { name: 'features', type: 'TABLE', value: new table.FeatureList(e.features) },
              {
                name: 'lookups',
                type: 'TABLE',
          ...
          ((subtableParsers[1] = function () {
            ...
            (subtableParsers[4] = function () {
              var e = this.parseUShort();
              return (
                check.argument(1 === e, 'GSUB ligature table identifier-format must be 1'),
                {
                  substFormat: e,
                  coverage: this.parsePointer(Parser.coverage),
          ...
          ((subtableParsers[5] = function () {
            ...
            (subtableParsers[7] = function () {
              ...
              return { substFormat: 1, lookupType: t, extension: subtableParsers[t].call(s) };
            }),
          ...
          ((subtableMakers[1] = function (e) {
            return 1 === e.substFormat
              ? new table.Table('substitutionTable', [
                  ...
                  { name: 'coverage', type: 'TABLE', value: new table.Coverage(e.coverage) },
            ...
            (subtableMakers[3] = function (e) {
              return (
                check.assert(1 === e.substFormat, 'Lookup type 3 substFormat must be 1.'),
                new table.Table(
                  'substitutionTable',
                  [
                    { name: 'substFormat', type: 'USHORT', value: 1 },
            ...
            (subtableMakers[4] = function (e) {
              return (
                check.assert(1 === e.substFormat, 'Lookup type 4 substFormat must be 1.'),
                new table.Table(
                  'substitutionTable',
                  [
                    { name: 'substFormat', type: 'USHORT', value: 1 },
                        ...
                        table.tableList('ligature', e, function (e) {
                          return new table.Table(
                            ...
                            [{ name: 'ligGlyph', type: 'USHORT', value: e.ligGlyph }].concat(
                              table.ushortList('component', e.components, e.components.length + 1),
                            ),
                          );
                        }),
                      );
        ...
        function (require, module, exports) {
          ...
          function parseHeadTable(e, a) {
            ...
            return (
              ...
              check.argument(1594834165 === t.magicNumber, 'Font header has wrong magic number.'),
        ...
        function (require, module, exports) {
          ...
          function makeHmtxTable(e) {
            for (var a = new table.Table('hmtx', []), r = 0; r < e.length; r += 1) {
              ...
              (a.fields.push({ name: 'advanceWidth_' + r, type: 'USHORT', value: s }),
                a.fields.push({ name: 'leftSideBearing_' + r, type: 'SHORT', value: i }));
            }
            return a;
          }
          var parse = require('../parse'),
      ...
      24: [
        function (require, module, exports) {
          ...
          function parseLocaTable(r, a, e, s) {
            for (
              var p = new parse.Parser(r, a), o = s ? p.parseUShort : p.parseULong, t = [], c = 0;
              e + 1 > c;
              c += 1
            ) {
              var n = o.call(p);
          ...
          function makeLtagTable(e) {
            for (
              ...
              (0 > s && ((s = r.length), (r += e[n])),
                a.fields.push({ name: 'offset ' + n, type: 'USHORT', value: t + s }),
                a.fields.push({ name: 'length ' + n, type: 'USHORT', value: e[n].length }));
            }
          ...
          function makeMetaTable(e) {
            ...
            for (var n in e) {
              ...
              ((r += e[n]),
                ...
                s.fields.push({ name: 'offset ' + n, type: 'ULONG', value: t + p }),
                s.fields.push({ name: 'length ' + n, type: 'ULONG', value: e[n].length }));
            }
      ...
      28: [
        function (require, module, exports) {
          ...
          function parseNameTable(e, a, r) {
            for (
              ...
              if (void 0 !== v && void 0 !== h) {
                var x;
                if (
                  (x = v === utf16 ? decode.UTF16(e, i + p, f) : decode.MACSTRING(e, i + p, f, v))
                ) {
                  var y = n[d];
          ...
          function makeNameTable(e, a) {
            ...
            return (U.fields.push({ name: 'strings', type: 'LITERAL', value: l }), U);
          }
          var types = require('../types'),
            decode = types.decode,
            encode = types.encode,
        ...
        function (require, module, exports) {
          ...
          function parseOS2Table(e, n) {
            ...
            return (
              ...
              a.version >= 1 &&
                ((a.ulCodePageRange1 = i.parseULong()), (a.ulCodePageRange2 = i.parseULong())),
              a.version >= 2 &&
        ...
        function (require, module, exports) {
          ...
          function parsePostTable(e, a) {
            ...
            switch (
              ...
              case 2.5:
                for (
                  n.numberOfGlyphs = s.parseUShort(), n.offset = new Array(n.numberOfGlyphs), r = 0;
                  r < n.numberOfGlyphs;
                  r++
                )
      ...
      31: [
        function (require, module, exports) {
          ...
          function makeSfntTable(e) {
            ...
            for (
              var t = [], r = [], i = a.sizeOf() + makeTableRecord().sizeOf() * a.numTables;
              i % 4 !== 0;
            )
            ...
            for (var s = 0; s < e.length; s += 1) {
              ...
              for (
                t.push({ name: m.tag + ' Table Record', type: 'RECORD', value: m }),
                  r.push({ name: l.tableName + ' table', type: 'RECORD', value: l }),
                  i += u,
                  check.argument(!isNaN(i), 'Something went wrong calculating the offset.');
                i % 4 !== 0;
              )
                ((i += 1), r.push({ name: 'padding', type: 'BYTE', value: 0 }));
            }
          ...
          function fontToSfntTable(e) {
            ...
            (W.uniqueID || (W.uniqueID = { en: e.getEnglishName('manufacturer') + ':' + E }),
      ...
      32: [
        function (require, module, exports) {
          ...
          ((encode.BYTE = function (e) {
            return (
              check.argument(e >= 0 && 255 >= e, 'Byte value should be between 0 and 255.'),
              [e]
            );
          }),
            ...
            (encode.TAG = function (e) {
              return (
                check.argument(4 === e.length, 'Tag should be exactly 4 ASCII characters.'),
            ...
            (encode.OPERAND = function (e, n) {
              ...
              if (Array.isArray(n))
                for (var o = 0; o < n.length; o += 1)
                  (check.argument(e.length === n.length, 'Not enough arguments given for type' + n),
          ...
          ((encode.CHARSTRING = function (e) {
            ...
            (encode.OBJECT = function (e) {
              var n = encode[e.type];
              return (
                check.argument(void 0 !== n, 'No encoding function for type ' + e.type),
                n(e.value)
              );
            }),
            (sizeOf.OBJECT = function (e) {
              var n = sizeOf[e.type];
              return (
                check.argument(void 0 !== n, 'No sizeOf function for type ' + e.type),
                n(e.value)
              );
            }),
            (encode.TABLE = function (e) {
              ...
              for (n = 0; o > n; n += 1) {
                ...
                check.argument(
                  void 0 !== a,
                  'No encoding function for field type ' + i.type + ' (' + i.name + ')',
                );
                var f = e[i.name];
                void 0 === f && (f = i.value);
                var d = a(f);
