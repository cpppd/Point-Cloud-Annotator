...
K.prototype.b = function (f, d, c) {
  ...
  if (8 > d + a) ((g = (g << d) | f), (a += d));
    ...
    for (m = 0; m < d; ++m)
      ((g = (g << 1) | ((f >> (d - m - 1)) & 1)),
        8 === ++a && ((a = 0), (e[b++] = L[g]), (g = 0), b === e.length && (e = ca(this))));
  e[b] = g;
  this.buffer = e;
  this.e = a;
  this.index = b;
...
var da = new (C ? Uint8Array : Array)(256),
  M;
for (M = 0; 256 > M; ++M) {
  for (var N = M, S = N, ea = 7, N = N >>> 1; N; N >>>= 1) ((S <<= 1), (S |= N & 1), --ea);
  da[M] = ((S << ea) & 255) >>> 0;
}
var L = da;
function ia(f) {
...
function ka(f, d) {
  ...
  d &&
    ...
    d.outputBuffer &&
      (this.a =
        C && d.outputBuffer instanceof Array ? new Uint8Array(d.outputBuffer) : d.outputBuffer),
    ...
    case la:
      ...
      for (Ca = J.length; I < Ca; ++I)
        if ((($ = J[I]), B.b(Da[$], Ea[$], w), 256 < $))
          (B.b(J[++I], J[++I], w), (ma = J[++I]), B.b(Fa[ma], Ga[ma], w), B.b(J[++I], J[++I], w));
        else if (256 === $) break;
      this.a = B.finish();
      this.c = this.a.length;
      break;
...
var sa = (function () {
    ...
    var d = [],
      c,
      e;
    for (c = 3; 258 >= c; c++) ((e = f(c)), (d[c] = (e[2] << 24) | (e[1] << 16) | e[0]));
    return d;
  })(),
...
Ka.prototype.f = function () {
  ...
  C &&
    ...
    a.length <= g + 4 && ((this.a = new Uint8Array(a.length + 4)), this.a.set(a), (a = this.a)),
    (a = a.subarray(0, g + 4)));
  a[g++] = (b >> 24) & 255;
  a[g++] = (b >> 16) & 255;
  a[g++] = (b >> 8) & 255;
...
W = 0;
for (Pa = Na.length; W < Pa; ++W) ((Oa = Na[W]), ba('Zlib.Deflate.CompressionType.' + Oa, Ma[Oa]));
