...
((TWEEN.Group = _Group),
  ...
  (TWEEN.Tween.prototype = {
    ...
    start: function (t) {
      ...
      (this._onStartCallbackFired = !1),
      (this._startTime =
        void 0 !== t ? ('string' == typeof t ? TWEEN.now() + parseFloat(t) : t) : TWEEN.now()),
      ...
      this._valuesEnd))
        if (void 0 !== this._valuesStart[n]) {
          ...
          a instanceof Array
            ...
            : ('string' == typeof a &&
                (a =
                  '+' === a.charAt(0) || '-' === a.charAt(0) ? r + parseFloat(a) : parseFloat(a)),
  ...
  (TWEEN.Interpolation = {
    ...
    Bezier: function (t, n) {
      for (
        var e = 0, i = t.length - 1, r = Math.pow, a = TWEEN.Interpolation.Utils.Bernstein, s = 0;
        s <= i;
        s++
      )
