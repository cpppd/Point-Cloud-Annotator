...
((TWEEN.Tween = function (n) {
  ...
  ((this.to = function (n, t) {
    ...
    (this.stop = function () {
      return f
        ? (TWEEN.remove(this), (f = !1), null !== M && M.call(t), this.stopChainedTweens(), this)
        : this;
    }),
    ...
    Elastic: {
      In: function (n) {
        ...
        return 0 === n
          ...
          : 1 === n
            ? 1
            : (!r || 1 > r ? ((r = 1), (t = i / 4)) : (t = (i * Math.asin(1 / r)) / (2 * Math.PI)),
      ...
      InOut: function (n) {
        ...
        return 0 === n
          ...
          : 1 === n
            ...
            : (!r || 1 > r ? ((r = 1), (t = i / 4)) : (t = (i * Math.asin(1 / r)) / (2 * Math.PI)),
              (n *= 2) < 1
                ? -0.5 * r * Math.pow(2, 10 * (n -= 1)) * Math.sin((2 * (n - t) * Math.PI) / i)
                : r * Math.pow(2, -10 * (n -= 1)) * Math.sin((2 * (n - t) * Math.PI) / i) * 0.5 +
                  1);
      },
    },
    Back: {
    ...
    CatmullRom: function (n, t) {
      ...
      return n[0] === n[r]
        ? (0 > t && (u = Math.floor((i = r * (1 + t)))),
          o(n[(u - 1 + r) % r], n[u], n[(u + 1) % r], n[(u + 2) % r], i - u))
        : 0 > t
          ? n[0] - (o(n[0], n[0], n[1], n[1], -i) - n[0])
          : t > 1
            ? n[r] - (o(n[r], n[r], n[r - 1], n[r - 1], i - r) - n[r])
            : o(n[u ? u - 1 : 0], n[u], n[u + 1 > r ? r : u + 1], n[u + 2 > r ? r : u + 2], i - u);
    },
    Utils: {
