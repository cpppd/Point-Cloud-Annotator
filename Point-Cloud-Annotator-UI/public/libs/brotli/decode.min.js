function BrotliDecodeClosure() {
  ...
  function t(e) {
    for (var t = -1, i = 16; i > 0; ) (e >>> i != 0 && ((t += i), (e >>>= i)), (i >>= 1));
    return t + e;
  }
  function i(e, t, i) {
    return 16 + t + 2 * (i << e);
  ...
  function a(e) {
    ...
    for (var a = 0; a < 704; ++a) {
      ...
      var s = (((170064 >>> (2 * o)) & 3) << 3) | ((a >>> 3) & 7),
        ...
        d = r + (c > 4 ? 3 : c - 2),
        h = 4 * a;
      ((e[h + 0] = Pe[s] | ($e[l] << 8)), (e[h + 1] = t[s]), (e[h + 2] = i[l]), (e[h + 3] = d));
    }
  }
  function o(e) {
    var t = e.c;
      ...
      : ((i = H(e, 3)),
        0 != i
          ? 1 == i
            ? 0 == t
              ? -1
              : ((e.c = 1), 1 == H(e, 1) ? -1 : ((i = H(e, 6)), i < 10 || i > 30 ? -1 : i))
            : 8 + i
          : 17);
  }
  function r(e, t) {
    ...
    ((e.l = new Int8Array(i)), (e.m = new Int32Array(i)), (e.input = t), U(e), (e.h = 1));
  }
  function s(e) {
    if (0 == e.h) throw 'State MUST be initialized';
    11 != e.h && ((e.h = 11), null != e.input && (ne(e.input), (e.input = null)));
  }
  function l(e) {
    if ((e.d >= 16 && ((e.e = (e.f[e.g++] << 16) | (e.e >>> 16)), (e.d -= 16)), 0 != H(e, 1))) {
      var t = H(e, 3);
  ...
  function u(e, t, i, n) {
    ...
    for (W(c, d, 5, e, 18); a < t && l > 0; ) {
      (n.g > 2030 && B(n), n.d >= 16 && ((n.e = (n.f[n.g++] << 16) | (n.e >>> 16)), (n.d -= 16)));
      var h = (n.e >>> n.d) & 31;
      n.d += c[h] >> 16;
      var f = 65535 & c[h];
      if (f < 16) ((r = 0), (i[a++] = f), 0 != f && ((o = f), (l -= 32768 >> f)));
      else {
        var p = f - 14,
          u = 0;
        ...
        var m = r;
        (r > 0 && ((r -= 2), (r <<= p)),
          n.d >= 16 && ((n.e = (n.f[n.g++] << 16) | (n.e >>> 16)), (n.d -= 16)),
          (r += H(n, p) + 3));
        var g = r - m;
  ...
  function g(e, i, n, a, o) {
    for (
      var r = new Int32Array(i), s = new Int32Array(4), l = 1 + t(e - 1), c = H(o, 2) + 1, d = 0;
      d < c;
      d++
    ) {
      o.d >= 16 && ((o.e = (o.f[o.g++] << 16) | (o.e >>> 16)), (o.d -= 16));
      var h = H(o, l);
  ...
  function P(e, t, i, n, a) {
    for (
      var o = new Int32Array(e), r = new Int32Array(18), s = 32, l = 0, c = t;
      c < 18 && s > 0;
      c++
    ) {
      var d = ce[c];
      a.d >= 16 && ((a.e = (a.f[a.g++] << 16) | (a.e >>> 16)), (a.d -= 16));
      var h = (a.e >>> a.d) & 15;
      a.d += fe[h] >> 16;
      var f = 65535 & fe[h];
      ((r[d] = f), 0 != f && ((s -= 32 >> f), l++));
  ...
  function $(e, t, i, n, a) {
    (a.g > 2030 && B(a), a.d >= 16 && ((a.e = (a.f[a.g++] << 16) | (a.e >>> 16)), (a.d -= 16)));
    var o = H(a, 2);
  ...
  function b(e, t, i) {
    ...
    $(r, r, c, h, i);
    for (var f = 0; f < e; ) {
      (i.g > 2030 && B(i), i.d >= 16 && ((i.e = (i.f[i.g++] << 16) | (i.e >>> 16)), (i.d -= 16)));
      var u = d(c, h, i);
      if (0 == u) ((t[f] = 0), f++);
      else if (u <= o) {
        i.d >= 16 && ((i.e = (i.f[i.g++] << 16) | (i.e >>> 16)), (i.d -= 16));
  ...
  function Q(e) {
    return 0 != e.n
      ...
      : ((e.O = new Int32Array(0)),
        ...
        void (
          (0 == e.o && 0 == e.q) ||
          (0 != e.p || 0 != e.q ? (J(e), (e.h = 0 != e.q ? 5 : 6)) : (e.h = 3),
          0 == e.q && ((e.I += e.o), e.I > 1 << 30 && (e.I = 1 << 30), e.J < e.H && Y(e)))
        ));
  }
  function k(e, t, i) {
    var n = e.j[2 * t];
    ...
    var o = 26;
    return ((n += $(o, o, e.j, 2 * t + 1, e)), (e.j[2 * t + 2] = n), h(e.j, 2 * t + 1, e));
  }
  function x(e, t) {
    for (
      var i = e.l, n = e.m, a = e.R, o = e.S, r = 1 << a, s = 1, l = 0, c = 16, d = 0;
      d < o;
      ++d
    )
      ((i[c] = 0), (n[c] = d + 1), ++c);
  ...
  function C(e) {
    ...
    for (var t = 0; t < e.t; ) {
      for (var a = te(t + 96, e.t); t < a; ++t)
        (e.d >= 16 && ((e.e = (e.f[e.g++] << 16) | (e.e >>> 16)), (e.d -= 16)), (e.x[t] = H(e, 2)));
      e.g > 2030 && B(e);
    }
  ...
  function A(e) {
    ...
    return (
      0 != t && (e._.L(e.K.M(e.$, e.$ + t), e.aa + e.Y), (e.Y += t), (e.$ += t)),
      e.Y < e.X ? 1 : 0
    );
  }
  function I(e, t, i, n) {
    for (var a = le[(t + 31) >> 5], o = new Int32Array(i + i * a), r = i, s = 0; s < i; ++s)
      ((o[s] = r), (r += $(e, t, o, s, n)));
    return o;
  }
  function q(e) {
      ...
      switch (e.h) {
        ...
        case 4:
          ...
          ((e.da = l + (h <= 16 ? H(e, h) : R(e, h))),
            e.d >= 16 && ((e.e = (e.f[e.g++] << 16) | (e.e >>> 16)), (e.d -= 16)));
          var h = s >> 8;
          ((e.ea = c + (h <= 16 ? H(e, h) : R(e, h))), (e.fa = 0), (e.h = 7));
        case 7:
          if (0 != e.U) {
            for (; e.fa < e.da; )
              if (
            ...
            for (var f = 255 & a[(e.W - 1) & n], p = 255 & a[(e.W - 2) & n]; e.fa < e.da; ) {
          ...
          if (g < 0) e.ga = e.r[e.k];
            ...
            if (((g = d(e.Q, P, e)), g < 16)) {
              var $ = (e.k + de[g]) & 3;
              if (((e.ga = e.r[$] + he[g]), e.ga < 0)) throw 'Negative distance';
            } else {
              var b,
                h = e.l[g];
              (e.d + h <= 32
          ...
          if ((e.ha != e.ba && e.W < e.ba ? (e.ha = e.W) : (e.ha = e.ba), e.ga > e.ha)) {
            e.h = 9;
            continue;
          }
          if ((g > 0 && ((e.k = (e.k + 1) & 3), (e.r[e.k] = e.ga)), e.ea > e.o))
        ...
        case 8:
          ...
          if (x < n && I < n) {
            if (k < 12 || (x > Y && I > v))
              for (var T = 0; T < k; T += 4)
                ((a[Y++] = a[v++]), (a[Y++] = a[v++]), (a[Y++] = a[v++]), (a[Y++] = a[v++]));
            else a.copyWithin(Y, v, x);
            ((e.fa += k), (e.o -= k), (e.W += k));
          } else
            for (; e.fa < e.ea; )
              if (((a[e.W] = a[(e.W - e.ga) & n]), e.o--, e.W++, e.fa++, e.W >= i)) {
                ((e.N = 8), (e.h = 12));
                break;
              }
          8 == e.h && (e.h = 4);
        ...
        case 9:
          ...
          if (!(e.ea >= 4 && e.ea <= 24)) throw 'Invalid backward reference';
          var S = pe[e.ea],
            E = e.ga - e.ha - 1,
            D = ue[e.ea],
            N = (1 << D) - 1,
            F = E & N,
            W = E >>> D;
          if (((S += F * e.ea), !(W < 121))) throw 'Invalid backward reference';
        ...
        case 13:
          if (0 == A(e)) return;
          (e.W >= e.ba && (e.ha = e.ba),
            e.W >= e.J && (e.W > e.J && a.copyWithin(0, e.J, e.W), (e.W &= n), (e.$ = 0)),
            (e.h = e.N));
          continue;
        default:
  ...
  function z(e, t, i, n, a, o, r) {
    var s = t,
      ...
      b = p - 11,
      v = p - 0;
    for ((b < 1 || b > 9) && (b = 0), (v < 1 || v > 9) && (v = 0); m != g; ) e[s++] = c[m++];
    (b > a && (b = a), (n += b), (a -= b), (a -= v));
    ...
    if (10 == p || 11 == p) {
      ...
      for (var Y = s - a, Q = o.ma[r], k = (32767 & Q) + (16777216 - (32768 & Q)); a > 0; ) {
        var x = 1,
          w = 255 & e[Y];
  ...
  function F(e, t, i) {
    for (var n = 1 << (t - i); t < 15 && ((n -= e[t]), !(n <= 0)); ) (t++, (n <<= 1));
    return t - i;
  }
  function W(e, t, i, n, a) {
    ...
    for (var h = 1, m = 2; h <= i; h++, m <<= 1)
      for (; c[h] > 0; c[h]--) (N(e, s + o, m, p, (h << 16) | l[r++]), (o = D(o, h)));
    for (var g = u - 1, P = -1, $ = s, h = i + 1, m = 2; h <= 15; h++, m <<= 1)
      for (; c[h] > 0; c[h]--)
        ((o & g) != P &&
          (($ += p),
          (f = F(c, h, i)),
  ...
  function R(e, t) {
    var i = H(e, 16);
    return ((e.e = (e.f[e.g++] << 16) | (e.e >>> 16)), (e.d -= 16), i | (H(e, t - 16) << 16));
  }
  function U(e) {
  ...
  function G(e, t, i, n) {
    ...
    if (0 != n) {
      ...
      if (0 != n) {
        if (_(e) > 0) {
          for (e.d >= 16 && ((e.e = (e.f[e.g++] << 16) | (e.e >>> 16)), (e.d -= 16)); 0 != n; )
            ((t[i++] = e.e >>> e.d), (e.d += 8), n--);
          return void M(e, 0);
        }
        for (; n > 0; ) {
  ...
  function V(e, t, i) {
    for (var n = 0; n < 256; ++n)
      ((e[n] = 63 & n), (e[512 + n] = n >> 2), (e[1792 + n] = 2 + (n >> 6)));
    for (var n = 0; n < 128; ++n) e[1024 + n] = 4 * (t.charCodeAt(n) - 32);
    for (var n = 0; n < 64; ++n) ((e[1152 + n] = 1 & n), (e[1216 + n] = 2 + (1 & n)));
    for (var a = 1280, o = 0; o < 19; ++o)
      for (var r = 3 & o, s = i.charCodeAt(o) - 32, n = 0; n < s; ++n) e[a++] = r;
  ...
  function ae(e) {}
  function oe(e) {
    for (var t = e.length, i = new Int8Array(t), n = 0; n < t; ++n) i[n] = e.charCodeAt(n);
    return i;
  }
  function re(t) {
    var i = new Z();
    ...
    for (var n = 0, a = []; ; ) {
      ...
      if (
        (a.push(o), (i._ = o), (i.aa = 0), (i.X = 16384), (i.Y = 0), T(i), (n += i.Y), i.Y < 16384)
      )
        break;
    }
    s(i);
  ...
  var se = new Int8Array(0),
    ...
    ce = Int32Array.from([1, 2, 3, 4, 0, 5, 17, 6, 16, 7, 8, 9, 10, 11, 12, 13, 14, 15]),
    de = Int32Array.from([0, 3, 2, 1, 0, 0, 0, 0, 0, 0, 3, 3, 3, 3, 3, 3]),
    he = Int32Array.from([0, 0, 0, 0, -1, 1, -2, 2, -3, 3, -1, 1, -2, 2, -3, 3]),
    fe = Int32Array.from([
      131072, 131076, 131075, 196610, 131072, 131076, 131075, 262145, 131072, 131076, 131075,
      196610, 131072, 131076, 131075, 262149,
    ]),
    pe = Int32Array.from([
