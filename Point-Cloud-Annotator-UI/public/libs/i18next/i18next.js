...
!(function (a) {
  ...
  function f(a) {
    var b = function (a) {
      ...
      g = function (a, d, e, h) {
        ...
        if (
          ((i = 'application/json' === j['content-type'] ? JSON.stringify(e.data) : c(e.data)),
          'GET' === a)
        ) {
          var k = [];
          if (
  ...
  function g(a, b) {
    ('function' == typeof a && ((b = a), (a = {})),
      ...
      'string' == typeof P.ns && (P.ns = { namespaces: [P.ns], defaultNs: P.ns }),
      'string' == typeof P.fallbackNS && (P.fallbackNS = [P.fallbackNS]),
      ('string' == typeof P.fallbackLng || 'boolean' == typeof P.fallbackLng) &&
        (P.fallbackLng = [P.fallbackLng]),
      (P.interpolationPrefixEscaped = T.regexEscape(P.interpolationPrefix)),
      (P.interpolationSuffixEscaped = T.regexEscape(P.interpolationSuffix)),
      ...
      P.useCookie &&
        ...
        T.cookie.create(P.cookieName, H, P.cookieExpirationTime, P.cookieDomain),
    ...
    if ((I && I.Deferred && (d = I.Deferred()), !P.resStore)) {
      ...
      for (var f = 0, g = P.preload.length; g > f; f++)
        for (var h = T.toLanguages(P.preload[f]), i = 0, j = h.length; j > i; i++)
  ...
  function q(a, b) {
    ...
    for (var e = 0, f = P.preload.length; f > e; e++)
      for (var g = T.toLanguages(P.preload[e]), h = 0, i = g.length; i > h; h++)
            ...
            (P.ns.namespaces.indexOf(c) < 0 && P.ns.namespaces.push(c),
              T.each(j, function (a, f) {
                ((K[f] = K[f] || {}),
                  (K[f][c] = d[f][c]),
                  e--,
                  0 === e && b && (P.useLocalStorage && J.sync._storeLocal(K), b()));
              }));
          });
        })
      : b && b();
  ...
  function u() {
    function a(a, b, c) {
      if (0 !== b.length) {
        ...
        var f;
        if ('html' === d)
          ((f = P.defaultValueFromContent ? I.extend({ defaultValue: a.html() }, c) : c),
            a.html(I.t(b, f)));
        else if ('text' === d)
          ((f = P.defaultValueFromContent ? I.extend({ defaultValue: a.text() }, c) : c),
            a.text(I.t(b, f)));
        else if ('prepend' === d)
          ((f = P.defaultValueFromContent ? I.extend({ defaultValue: a.html() }, c) : c),
            a.prepend(I.t(b, f)));
          ...
          ((f = P.defaultValueFromContent ? I.extend({ defaultValue: a.attr(d) }, c) : c),
            a.attr(d, I.t(b, f)));
      }
    }
    function b(b, c) {
      ...
      if ((d || 'undefined' == typeof d || d === !1 || (d = b.text() || b.val()), d)) {
        ...
        if (
          (f && (e = b.find(f) || b),
          c || P.useDataAttrOptions !== !0 || (c = b.data('i18n-options')),
          (c = c || {}),
          d.indexOf(';') >= 0)
        ) {
          var g = d.split(';');
      ...
      T.each(h, function (b, h) {
        ...
        'object' == typeof h && null !== h
          ...
          : d.escapeInterpolation || P.escapeInterpolation
            ? ((a = a.replace(new RegExp([e, i, g].join(''), 'g'), T.regexReplacementEscape(h))),
              (a = a.replace(
                new RegExp([e, i, f].join(''), 'g'),
                T.regexReplacementEscape(T.escape(h)),
              )))
            : (a = a.replace(new RegExp([e, i, f].join(''), 'g'), T.regexReplacementEscape(h)));
      }),
      a
    );
  }
  function w(a, b) {
    ...
    for (delete f.postProcess; -1 != a.indexOf(P.reusePrefix) && (L++, !(L > P.maxRecursion)); ) {
      ...
      if (g >= h)
        return (T.error('there is an missing closing in following translation value', a), '');
      if (-1 != j.indexOf(c)) {
        var k = j.indexOf(c);
  ...
  function E(a, b) {
    if (
      (b && 'object' != typeof b
        ? 'sprintf' === P.shortcutFunction
          ...
          : 'defaultValue' === P.shortcutFunction && (b = { defaultValue: b })
        : (b = b || {}),
      'object' == typeof P.defaultVariables && (b = T.extend({}, P.defaultVariables, b)),
      void 0 === a || null === a || '' === a)
    )
      return '';
    ...
    (c.indexOf(P.nsseparator) > -1 && ((e = c.split(P.nsseparator)), (i = e[0]), (c = e[1])),
      void 0 === g &&
        ...
        (b.lng ? P.missingKeyHandler(h[0], i, c, f, h) : P.missingKeyHandler(P.lng, i, c, f, h)));
    var j;
    ((j =
      'string' == typeof P.postProcess && '' !== P.postProcess
        ? [P.postProcess]
        : 'array' == typeof P.postProcess || 'object' == typeof P.postProcess
          ? P.postProcess
          : []),
      'string' == typeof b.postProcess && '' !== b.postProcess
        ? (j = j.concat([b.postProcess]))
        : ('array' == typeof b.postProcess || 'object' == typeof b.postProcess) &&
          (j = j.concat(b.postProcess)),
      void 0 !== g &&
        j.length &&
    ...
    var k = f;
    if (
      (f.indexOf(P.nsseparator) > -1 && ((e = f.split(P.nsseparator)), (k = e[1])),
  ...
  function F(a, b) {
    ...
    if (z(b)) {
      ...
      var o =
        h + P.nsseparator + a + ((b.count && !y(b, f[0])) || !b.count ? P.indefiniteSuffix : '');
    ...
    for (var p, q = a.split(P.keyseparator), r = 0, s = f.length; s > r && void 0 === p; r++) {
      ...
      if (void 0 !== A) {
        ...
        if ('string' == typeof A) ((A = v(A, b)), (A = w(A, b)));
        else if ('[object Array]' !== D || P.returnObjectTrees || b.returnObjectTrees) {
          if (null === A && P.fallbackOnNull === !0) A = void 0;
            ...
            if (P.returnObjectTrees || b.returnObjectTrees) {
              ...
              P.objectTreeKeyHandler && 'function' == typeof P.objectTreeKeyHandler
                ? (A = P.objectTreeKeyHandler(a, A, t, h, b))
                : ((A =
                    "key '" + h + ':' + a + ' (' + t + ")' returned an object instead of string."),
                  T.log(A));
        } else ((A = A.join('\n')), (A = v(A, b)), (A = w(A, b)));
    ...
    if (
      void 0 === p &&
      !b.isFallbackLookup &&
      (P.fallbackToDefaultNS === !0 || (P.fallbackNS && P.fallbackNS.length > 0))
    ) {
      if (((b.isFallbackLookup = !0), P.fallbackNS.length)) {
        for (var H = 0, I = P.fallbackNS.length; I > H; H++)
          if (
            ...
            var L = p.indexOf(P.nsseparator) > -1 ? p.split(P.nsseparator)[1] : p,
              N = e.indexOf(P.nsseparator) > -1 ? e.split(P.nsseparator)[1] : e;
            if (L !== N) break;
          }
      } else p = F(a, b);
  ...
  function G() {
    ...
    if (
      ('undefined' != typeof window &&
        !(function () {
          for (
            var a = window.location.search.substring(1), b = a.split('&'), d = 0;
            d < b.length;
            d++
          ) {
            var e = b[d].indexOf('=');
    ...
    if (
      ...
      if (navigator.languages)
        for (var e = 0; e < navigator.languages.length; e++) c.push(navigator.languages[e]);
    ...
    (O = {
      ...
      postMissing: function (a, b, c, d, e) {
        ...
        if ('fallback' === P.sendMissingTo && P.fallbackLng[0] !== !1)
          ...
          g.push({ lng: a, url: v(P.resPostPath, { lng: a, ns: b }) });
        else if ('all' === P.sendMissingTo)
          for (var h = 0, i = e.length; i > h; h++)
            g.push({ lng: e[h], url: v(P.resPostPath, { lng: e[h], ns: b }) });
        for (var j = 0, k = g.length; k > j; j++) {
          ...
          T.ajax({
            ...
            success: function () {
              ...
              for (var a = c.split('.'), e = 0, f = K[l.lng][b]; a[e]; )
      ...
      toLanguages: function (a) {
        ...
        if ('string' == typeof a && a.indexOf('-') > -1) {
          ...
          ('unspecific' !== P.load && f(b(a)),
            'current' !== P.load && f(b(g[this.getCountyIndexOfLng(a)])));
        } else f(b(a));
        for (var h = 0; h < P.fallbackLng.length; h++)
          -1 === d.indexOf(P.fallbackLng[h]) && P.fallbackLng[h] && d.push(b(P.fallbackLng[h]));
        return d;
      },
  ...
  var U = [
    ...
    V = {
      ...
      7: function (a) {
        return Number(
          1 == a ? 0 : a % 10 >= 2 && 4 >= a % 10 && (10 > a % 100 || a % 100 >= 20) ? 1 : 2,
        );
      },
      8: function (a) {
      ...
      15: function (a) {
        return Number(
          a % 10 == 1 && a % 100 != 11 ? 0 : a % 10 >= 2 && (10 > a % 100 || a % 100 >= 20) ? 1 : 2,
        );
      },
      16: function (a) {
    ...
    W = {
      rules: (function () {
        var a,
          b = {};
        for (a = U.length; a--; )
          b[U[a][0]] = { name: U[a][1], numbers: U[a][2], plurals: V[U[a][3]] };
        return b;
      })(),
              ...
              if (((h = c[f]), h[2]))
                for (e = d[l], g = 0; g < h[2].length; g++) {
                  if (!e.hasOwnProperty(h[2][g]))
                    throw Z('[sprintf] property "%s" does not exist', h[2][g]);
                  e = e[h[2][g]];
                }
              else e = h[1] ? d[h[1]] : d[l++];
              if (/[^s]/.test(h[8]) && 'number' != a(e))
                throw Z('[sprintf] expecting number but found %s', a(e));
              switch (h[8]) {
                case 'b':
                  e = e.toString(2);
                  break;
