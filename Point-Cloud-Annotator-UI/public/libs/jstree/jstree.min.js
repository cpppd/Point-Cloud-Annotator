...
!(function (a) {
  ...
  if (!a.jstree) {
      ...
      (a.jstree.core.prototype = {
          ...
          this.element
            ...
            .on(
              ...
              a.proxy(function (a) {
                if (a.target.tagName && 'input' === a.target.tagName.toLowerCase()) return !0;
                this._data.core.rtl &&
                  (37 === a.which ? (a.which = 39) : 39 === a.which && (a.which = 37));
            ...
            return (
              c &&
                (b =
                  b.id === a.jstree.root
                    ? this.element
                    : a('#' + b.id.replace(a.jstree.idregex, '\\$&'), this.element)),
              b
            );
          } catch (e) {
            return !1;
            ...
            this._load_node(
              ...
              a.proxy(function (a) {
                ...
                (b.state.loaded &&
                  ...
                  h
                    ? '#' !== b.id && d.addClass(b.state.opened ? 'jstree-open' : 'jstree-closed')
                ...
                if (c.length && c[0].id !== b && c[0].parent !== b) {
                  ...
                  for (p = 0, q = c.length; q > p; p++)
                    l[c[p].parent.toString()]
                      ? (l[c[p].parent.toString()].children.push(c[p].id.toString()),
        ...
        redraw_node: function (b, c, d, e) {
          ...
          if (
            ...
            for (k++, l = p[f.parent].children.length; l > k; k++)
              if (
                (p[p[f.parent].children[k]].state.hidden || (w = p[f.parent].children[k]),
                w !== f.id)
              )
                break;
                          ...
                          ? (this.trigger('before_open', { node: c }),
                            h
                              ...
                              .slideDown(e, function () {
                                ((this.style.display = ''),
                                  i.element && i.trigger('after_open', { node: c }));
                              }))
                          : (this.trigger('before_open', { node: c }),
        ...
        select_all: function (b) {
          var c = this._data.core.selected.concat([]),
            ...
            e;
          for (
            this._data.core.selected = this._model.data[a.jstree.root].children_d.concat(),
              d = 0,
        ...
        move_node: function (c, d, e, f, g, h, i) {
          ...
          if (c.parent === n.id) {
            ...
            for (r = c.children_d.concat(), r.push(c.id), s = 0, t = c.parents.length; t > s; s++) {
              for (
                q = [], w = o._model.data[c.parents[s]].children_d, u = 0, v = w.length;
                v > u;
                u++
              )
        ...
        set_theme: function (b, c) {
          ...
          (c &&
            -1 === a.inArray(c, g) &&
            (a('head').append('<link rel="stylesheet" href="' + c + '" type="text/css" />'),
            g.push(c)),
        ...
        ((a.vakata.context = {
            ...
            return (
              ...
              (!b._disabled ||
                (a.isFunction(b._disabled) &&
                  !b._disabled({ item: b, reference: c.reference, element: c.element }))) &&
              b.action
                ? b.action.call(null, {
                    item: b,
                    reference: c.reference,
          ...
          _show_submenu: function (c) {
            if (((c = a(c)), c.length && c.children('ul').length)) {
              ...
              (b
                ? c[f - (h + 10 + c.outerWidth()) < 0 ? 'addClass' : 'removeClass'](
                    'vakata-context-left',
                  )
      ...
      ((this.init = function (a, b) {
        (c.init.call(this, a, b),
          (this.settings.dnd.use_html5 =
            this.settings.dnd.use_html5 && 'draggable' in i.createElement('span')));
      }),
        (this.bind = function () {
          (c.bind.call(this),
            this.element.on(
            ...
            this.settings.dnd.use_html5 &&
              this.element
                .on('dragover.jstree', function (b) {
                  return (
                    b.preventDefault(),
                    a.vakata.dnd._trigger('move', b, { helper: a(), element: l, data: k }),
                    !1
                  );
                })
                .on(
                  ...
                  a.proxy(function (b) {
                    return (
                      b.preventDefault(),
                      a.vakata.dnd._trigger('stop', b, { helper: a(), element: l, data: k }),
                      !1
                    );
                  }, this),
                ));
                ...
                if (
                  ...
                  if (
                    ...
                    l &&
                      ...
                      ((m = l.offset()),
                      (n =
                        (i.event.pageY !== b ? i.event.pageY : i.event.originalEvent.pageY) -
                        m.top),
                      (r = l.outerHeight()),
                      (u =
                        r / 3 > n
        ...
        a.vakata.dnd = {
          ...
          _scroll: function (b) {
            if (!c.scroll_e || (!c.scroll_l && !c.scroll_t))
              return (c.scroll_i && (clearInterval(c.scroll_i), (c.scroll_i = !1)), !1);
              ...
              return (
                  ...
                  .each(function () {
                    ...
                    return (
                      this.scrollHeight > this.offsetHeight &&
                        (e.top + d.height() - b.pageY < a.vakata.dnd.settings.scroll_proximity &&
                          (c.scroll_t = 1),
                        b.pageY - e.top < a.vakata.dnd.settings.scroll_proximity &&
                          (c.scroll_t = -1)),
                      this.scrollWidth > this.offsetWidth &&
                        (e.left + d.width() - b.pageX < a.vakata.dnd.settings.scroll_proximity &&
                          (c.scroll_l = 1),
                        b.pageX - e.left < a.vakata.dnd.settings.scroll_proximity &&
                          (c.scroll_l = -1)),
                ...
                c.scroll_e ||
                  ...
                  h > j &&
                    ...
                    (c.scroll_l = -1),
                  h > j &&
                    j - (b.pageX - l) < a.vakata.dnd.settings.scroll_proximity &&
                    (c.scroll_l = 1),
          ...
          (this._load_nodes = function (b, d, e, f) {
            ...
            if (!e) {
              for (k = 0, l = b.length; l > k; k++)
                (!j[b[k]] || (!j[b[k]].state.loaded && !j[b[k]].state.failed) || f) &&
                  (i.push(b[k]),
                ...
                for (
                  ...
                  if (
                    ...
                    0 === c
                      ? (u[f] = ((u[f + 1] << 1) | 1) & v)
                      : (u[f] =
                          (((u[f + 1] << 1) | 1) & v) | (((r[f + 1] | r[f]) << 1) | 1) | r[f + 1]),
                    u[f] & i && ((w = k(c, f - 1)), m >= w))
                  ) {
      ...
      (a.jstree.plugins.types = function (c, d) {
        ((this.init = function (c, e) {
                    ...
                    for (k in g[j].li_attr)
                      if (g[j].li_attr.hasOwnProperty(k)) {
                        ...
                        e[f[h]].li_attr[k] === b
                          ...
                          : 'class' === k &&
                            (e[f[h]].li_attr['class'] =
                              g[j].li_attr['class'] + ' ' + e[f[h]].li_attr['class']);
                      }
                      ...
                      if (g[j].a_attr.hasOwnProperty(k)) {
                        ...
                        e[f[h]].a_attr[k] === b
                          ...
                          : 'href' === k && '#' === e[f[h]].a_attr[k]
                            ...
                            : 'class' === k &&
                              (e[f[h]].a_attr['class'] =
                                g[j].a_attr['class'] + ' ' + e[f[h]].a_attr['class']);
                      }
                }
          ...
          (this.get_json = function (b, c, e) {
            ...
            if (a.isArray(j))
              for (f = 0, g = j.length; g > f; f++)
                ((j[f].type =
                  j[f].id && h[j[f].id] && h[j[f].id].type ? h[j[f].id].type : 'default'),
                  c &&
                    c.no_id &&
                    (delete j[f].id,
          ...
          (this.get_type = function (b, c) {
            return (
              (b = this.get_node(b)),
              b ? (c ? a.extend({ type: b.type }, this.settings.types[b.type]) : b.type) : !1
            );
          }),
            ...
            if (
              ...
              for (k in f[i].li_attr)
                if (f[i].li_attr.hasOwnProperty(k)) {
                  if ('id' === k) continue;
                  'class' === k
                    ? ((e[c.id].li_attr['class'] = (e[c.id].li_attr['class'] || '').replace(
                        f[i].li_attr[k],
                        '',
                      )),
            ...
            if (f[i] && f[i].a_attr !== b && 'object' == typeof f[i].a_attr)
              for (k in f[i].a_attr)
                if (f[i].a_attr.hasOwnProperty(k)) {
                  if ('id' === k) continue;
                  'class' === k
                    ? ((e[c.id].a_attr['class'] = (e[c.id].a_attr['class'] || '').replace(
                        f[i].a_attr[k],
                        '',
                      )),
                ...
                if (f[d].li_attr.hasOwnProperty(k)) {
                  ...
                  e[c.id].li_attr[k] === b
                    ? ((e[c.id].li_attr[k] = f[d].li_attr[k]),
                      l &&
                        ('class' === k ? l.addClass(f[d].li_attr[k]) : l.attr(k, f[d].li_attr[k])))
                    : 'class' === k &&
          ...
          (this.create_node = function (c, e, f, g, h) {
            if (!e || e.text === b) {
              ...
              var i,
                ...
                r;
              for (
                j = i = this.get_string('New node'), k = [], l = 0, m = c.children.length;
                m > l;
                l++
              )
    ...
    if (
      ...
      try {
        window.customElements.define('vakata-jstree', function () {}, { prototype: o });
      } catch (p) {}
    }
  }
});
