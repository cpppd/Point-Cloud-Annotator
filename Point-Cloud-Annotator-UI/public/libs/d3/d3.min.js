!(function () {
  ...
  function D(n) {
    ...
    return function (e, r) {
      ...
      r
        ? ((t.lastIndex = 0), t.test(u) || e.setAttribute('class', q(u + ' ' + n)))
      ...
      : (null == n ||
          ...
          (4 === n.length
            ? ((o = (3840 & i) >> 4),
              ...
              (c = (c << 4) | c))
            : 7 === n.length &&
              ((o = (16711680 & i) >> 16), (a = (65280 & i) >> 8), (c = 255 & i))),
        t(o, a, c));
  }
  function _t(n, t, e) {
    var r,
    ...
    function e(n, t, e, r) {
      for (var u, i, o, a = 0, c = t.length, l = e.length; c > a; ) {
        ...
        if (((u = t.charCodeAt(a++)), 37 === u)) {
          if (
            ((o = t.charAt(a++)), (i = C[o in sc ? t.charAt(a++) : o]), !i || (r = i(n, e, r)) < 0)
          )
            return -1;
  ...
  function Fe(n, t) {
    ...
    for (var a = 0, c = t.length; c > a; ++a) {
      ...
      if (s)
        for (
          var f = l[0], h = f[0], g = f[1] / 2 + qa / 4, p = Math.sin(g), v = Math.cos(g), d = 1;
          ;
        ) {
          (d === s && (d = 0), (n = l[d]));
          var m = n[0],
      ...
      return {
        ...
        point: function (f, h) {
          ...
          if (
            ...
            v !== c &&
              ((g = r(e, p)),
              (be(e, g) || be(p, g)) && ((p[0] += Ca), (p[1] += Ca), (v = t(p[0], p[1])))),
            v !== c)
          )
            ((s = 0),
              v
  ...
  function gr(n, t) {
    ...
    return function (u, i, o, a) {
      var c = o * t;
      null != u
        ? ((u = pr(e, u)), (i = pr(e, i)), (o > 0 ? i > u : u > i) && (u += o * La))
        : ((u = n + o * La), (i = n - 0.5 * c));
  ...
  function Fr(n, t) {
    ...
    var s = a - r,
      ...
      h = s / l;
    return f
      ? (-h + Math.sqrt(h * h - 2 * f * ((s * s) / (-2 * l) - c + l / 2 + u - i / 2))) / f + r
      : (r + a) / 2;
  }
  function Hr(n, t) {
    var e = n.N;
  ...
  function $r(n) {
    for (var t, e = Gc, r = Oe(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--; )
      ((t = e[u]),
        (!Br(t, n) || !r(t) || (ga(t.a.x - t.b.x) < Ca && ga(t.a.y - t.b.y) < Ca)) &&
  ...
  function iu(n, t) {
    ...
    for (Gc = [], Kc = new Array(n.length), Qc = new nu(), tl = new nu(); ; )
      if (((u = nl), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        ((i.x !== e || i.y !== r) && ((Kc[i.i] = new Or(i)), jr(i), (e = i.x), (r = i.y)),
          (i = n.pop()));
      else {
        if (!u) break;
        Ur(u.arc);
  ...
  function gu(n, t) {
    ...
    return function (n) {
      return (
        '#' + xt(Math.round(e + i * n)) + xt(Math.round(r + o * n)) + xt(Math.round(u + a * n))
      );
    };
  }
  function pu(n, t) {
    ...
    return (
      ...
      l != s
        ? (l - s > 180 ? (s += 360) : s - l > 180 && (l += 360),
          u.push({ i: r.push(r.pop() + 'rotate(', null, ')') - 2, x: vu(l, s) }))
      ...
      g[0] != p[0] || g[1] != p[1]
        ? ((e = r.push(r.pop() + 'scale(', null, ',', null, ')')),
          u.push({ i: e - 4, x: vu(g[0], p[0]) }, { i: e - 2, x: vu(g[1], p[1]) }))
  ...
  function Ju(n, t, e) {
    ...
    if (((n.charge = 0), !n.leaf))
      for (var i, o = n.nodes, a = o.length, c = -1; ++c < a; )
        ((i = o[c]),
          null != i &&
            (Ju(i, t, e), (n.charge += i.charge), (r += i.charge * i.cx), (u += i.charge * i.cy)));
    if (n.point) {
    ...
    if ((e = n.children) && (l = e.length)) {
      ...
      if (
        ...
        for (
          ...
          p
            ? (d > v || (v == d && u.r < r.r) ? mi(r, (u = a)) : mi((r = c), u), o--)
            : (di(r, i), (u = i), t(i));
        }
      var m = (s + f) / 2,
        y = (h + g) / 2,
        ...
        var c = u[0],
          ...
          s =
            n.length < 2
              ...
              : ((l - c) / (n.length - 1 + a)) | 0;
        return (
          (i = r(c + Math.round((s * a) / 2 + (l - c - (n.length - 1 + a) * s) / 2), s)),
          (o = 0),
  ...
  function ho(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = 'function' == typeof n ? (i = n) : (i = El.get(n) || go).key), t)
          : o;
      }),
  ...
  function xo(n, t) {
    return n.length < 3
      ? go(n)
      : n[0] + _o((n.push(n[0]), n), wo([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function bo(n, t) {
  ...
  function _o(n, t) {
    ...
    if (
      (e &&
        ((r +=
          'Q' + (i[0] - (2 * o[0]) / 3) + ',' + (i[1] - (2 * o[1]) / 3) + ',' + i[0] + ',' + i[1]),
        (u = n[1]),
        (c = 2)),
      t.length > 1)
    ) {
  ...
  function $o(n, t, e, r, u) {
    ...
    if (!o) {
      var a = u.time;
      ((o = i[r] =
        { tween: new l(), time: a, delay: u.delay, duration: u.duration, ease: u.ease, index: t }),
        (u = null),
        ++i.count,
        ta.timer(
          function (u) {
        ...
        return function () {
          function a() {
            ...
            r &&
              ...
              (p |= n | e),
              (M = r),
              g({ type: 'drag', x: r[0] + l[0], y: r[1] + l[1], dx: n, dy: e }));
          }
          function c() {
            t(h, v) &&
  ...
  ((ta.geo.clipExtent = function () {
    var n,
      ...
      o = {
        ...
        extent: function (a) {
          return arguments.length
            ? ((i = Ie((n = +a[0][0]), (t = +a[0][1]), (e = +a[1][0]), (r = +a[1][1]))),
              u && ((u.valid = !1), (u = null)),
              o)
            : [
                [n, t],
    ...
    (ta.geo.albersUsa = function () {
      ...
      return (
        ...
        (n.scale = function (t) {
          return arguments.length
            ? (i.scale(t), o.scale(0.35 * t), a.scale(t), n.translate(i.translate()))
            : i.scale();
        }),
        (n.translate = function (t) {
  ...
  ((Jc.area = function () {
    ...
    (Jc.clip = function (n) {
      for (
        var t, e, r, u, i, o, a = Tr(n), c = -1, l = this.length - Tr(this), s = this[l - 1];
        ++c < l;
      ) {
        for (
          t = n.slice(), n.length = 0, u = this[c], i = t[(r = t.length - a) - 1], e = -1;
          ++e < r;
        )
          ((o = t[e]),
            qr(o, s, u)
    ...
    (nu.prototype = {
      insert: function (n, t) {
        ...
        if (n) {
          ...
          this._
            ? ((n = uu(this._)), (t.P = null), (t.N = n), (n.P = n.L = t), (e = n))
        ...
        if (
          ...
          i && o
            ? ((r = e.C),
              ...
              (i.U = e),
              e !== o
                ? ((u = e.U), (e.U = n.U), (n = e.R), (u.L = n), (e.R = o), (o.U = e))
                : ((e.U = u), (u = e), (n = e.R)))
            : ((r = n.C), (n = e)),
          n && (n.U = u),
          !r)
        ...
        : ((i.x = function (n) {
          ...
          (i.extent = function (n) {
            return arguments.length
              ? (null == n
                  ? (t = e = r = u = null)
                  : ((t = +n[0][0]), (e = +n[0][1]), (r = +n[1][0]), (u = +n[1][1])),
                i)
              : null == t
                ? null
                : [
        ...
        (a.alpha = function (n) {
          return arguments.length
            ? ((n = +n),
              r
                ? (r = n > 0 ? n : 0)
                : n > 0 && (c.start({ type: 'start', alpha: (r = n) }), ta.timer(a.tick)),
              a)
            : r;
        }),
        (a.start = function () {
          ...
          return (
            e ||
              (e = ta.behavior
                ...
                .on('dragend.force', $u)),
            arguments.length
              ? void this.on('mouseover.force', Bu).on('mouseout.force', Wu).call(e)
              : e
          );
        }),
        ta.rebind(a, c, 'on')
        ...
        if ((p = Math.min(Math.abs(l - n) / 2, +u.apply(this, arguments))) > 0.001) {
          ...
          var T = null == S ? [_, w] : null == x ? [y, M] : Lr([y, M], [S, k], [x, b], [_, w]),
            ...
            j =
              1 /
              Math.sin(
                Math.acos((R * P + D * U) / (Math.sqrt(R * R + D * D) * Math.sqrt(P * P + U * U))) /
                  2,
              ),
  ...
  ((Pl.call = _a.call),
    ...
    (Pl.transition = function () {
      for (
        var n, t, e, r, u = this.id, i = ++Ul, o = this.namespace, a = [], c = 0, l = this.length;
        l > c;
        c++
      ) {
        a.push((n = []));
