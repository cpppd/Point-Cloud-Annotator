...
!(function () {
  (define('Core/defined', [], function () {
    ...
    define(
      ...
      function (e, t, r) {
        ...
        function n(e, t) {
          ...
          var o = e.byteLength;
          if (0 === o || o % 4 != 0)
            throw new r('The length of key must be greater than 0 and a multiple of 4.');
          var s = new DataView(t),
            f = s.getUint32(0, !0);
          if (f === i || f === a) return t;
          for (
            var u, c = new DataView(e), l = 0, d = t.byteLength, h = d - (d % 8), w = o, b = 8;
            l < h;
          )
    ...
    (function (e) {
      ...
      else if ('function' == typeof define && define.amd) define('ThirdParty/pako_inflate', [], e);
      else {
        var t;
        ((t =
            ...
            function (e, t, r) {
              ...
              ((s[254] = s[254] = 1),
                ...
                (r.buf2string = function (e, t) {
                  ...
                  for (i = 0, r = 0; r < f; )
                    if ((a = e[r++]) < 128) u[i++] = a;
                    else if ((o = s[a]) > 4) ((u[i++] = 65533), (r += o - 1));
                    else {
                      for (a &= 2 === o ? 31 : 3 === o ? 15 : 7; o > 1 && r < f; )
                        ((a = (a << 6) | (63 & e[r++])), o--);
                      o > 1
                        ? (u[i++] = 65533)
                        : a < 65536
          ...
          7: [
            function (e, t, r) {
              ...
              t.exports = function (e, t) {
                var r, n, i, a, o, s, f, u, c, l, d, h, w, b, m, g, v, p, k, _, y, E, x, S, T;
                ((r = e.state),
                  (n = e.next_in),
                  (S = e.input),
                  (i = n + (e.avail_in - 5)),
                  ...
                  (v = (1 << r.distbits) - 1));
                e: do {
                  (w < 15 && ((h += S[n++] << w), (w += 8), (h += S[n++] << w), (w += 8)),
                    (p = b[h & g]));
                  t: for (;;) {
                    if (((k = p >>> 24), (h >>>= k), (w -= k), 0 === (k = (p >>> 16) & 255)))
                      T[a++] = 65535 & p;
                    else {
                      if (!(16 & k)) {
                        if (0 == (64 & k)) {
                      ...
                      r: for (;;) {
                        ...
                        if (
                          ...
                          (k &= 15),
                          w < k &&
                            ((h += S[n++] << w), (w += 8) < k && ((h += S[n++] << w), (w += 8))),
                          (y += h & ((1 << k) - 1)) > f)
                        ) {
                          ((e.msg = 'invalid distance too far back'), (r.mode = 30));
                          break e;
                        }
                        if (((h >>>= k), (w -= k), (k = a - o), y > k)) {
                          if ((k = y - k) > c && r.sane) {
                            ((e.msg = 'invalid distance too far back'), (r.mode = 30));
                            break e;
                          }
                          ...
                          for (; _ > 2; )
                            ((T[a++] = x[E++]), (T[a++] = x[E++]), (T[a++] = x[E++]), (_ -= 3));
                          _ && ((T[a++] = x[E++]), _ > 1 && (T[a++] = x[E++]));
                        } else {
                          E = a - y;
                          do {
                            ((T[a++] = T[E++]), (T[a++] = T[E++]), (T[a++] = T[E++]), (_ -= 3));
                          } while (_ > 2);
                          _ && ((T[a++] = T[E++]), _ > 1 && (T[a++] = T[E++]));
                        }
                        break;
                      }
                    }
          ...
          8: [
            function (e, t, r) {
              ...
              function c(e) {
                if (ve) {
                  var t;
                  for (m = new v.Buf32(512), g = new v.Buf32(32), t = 0; t < 144; ) e.lens[t++] = 8;
                  for (; t < 256; ) e.lens[t++] = 9;
                  for (; t < 280; ) e.lens[t++] = 7;
                  for (; t < 288; ) e.lens[t++] = 8;
                  for (y(x, e.lens, 0, 288, m, 0, e.work, { bits: 9 }), t = 0; t < 32; )
                    e.lens[t++] = 5;
                  (y(S, e.lens, 0, 32, g, 0, e.work, { bits: 5 }), (ve = !1));
                }
                ...
                return (
                  ...
                  n >= a.wsize
                    ...
                    : ((i = a.wsize - a.wnext),
                      ...
                      (n -= i),
                      n
                        ? (v.arraySet(a.window, t, r - n, n, 0), (a.wnext = n), (a.whave = a.wsize))
                        : ((a.wnext += i),
              ...
              function d(e, t) {
                ...
                e: for (;;)
                  switch (r.mode) {
                    case z:
                      ...
                      if (((d >>>= 4), (h -= 4), (ye = 8 + (15 & d)), 0 === r.wbits)) r.wbits = ye;
                      else if (ye > r.wbits) {
                    ...
                    case j:
                      if (2048 & r.flags) {
                        ...
                        if (
                          (512 & r.flags && (r.check = k(r.check, i, m, o)), (f -= m), (o += m), ye)
                        )
                          break e;
                    ...
                    case K:
                      ...
                      ((e.adler = r.check = n(d)), (d = 0), (h = 0), (r.mode = Y));
                    case Y:
                      if (0 === r.havedict)
                        return (
                          (e.next_out = s),
                    ...
                    case J:
                      ...
                      if (((r.length = 65535 & d), (d = 0), (h = 0), (r.mode = Q), t === B))
                        break e;
                    case Q:
                      r.mode = X;
                    case X:
                    ...
                    case te:
                      for (; r.have < r.nlen + r.ndist; ) {
                        ...
                        if (ve < 16) ((d >>>= me), (h -= me), (r.lens[r.have++] = ve));
                        else {
                          if (16 === ve) {
                            for (Se = me + 2; h < Se; ) {
                              if (0 === f) break e;
                            ...
                            ((ye = r.lens[r.have - 1]), (m = 3 + (3 & d)), (d >>>= 2), (h -= 2));
                          } else if (17 === ve) {
                            for (Se = me + 3; h < Se; ) {
                              if (0 === f) break e;
                              (f--, (d += i[o++] << h), (h += 8));
                      ...
                      if (
                        ((r.lenbits = 9),
                        (xe = { bits: r.lenbits }),
                        (Ee = y(x, r.lens, 0, r.nlen, r.lencode, 0, r.work, xe)),
                        (r.lenbits = xe.bits),
                        Ee)
                      ) {
                      ...
                      if (
                        ...
                        (xe = { bits: r.distbits }),
                        (Ee = y(S, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, xe)),
                        (r.distbits = xe.bits),
                        Ee)
                      ) {
                    ...
                    case ne:
                      ...
                      if (ge && 0 == (240 & ge)) {
                        for (
                          pe = me, ke = ge, _e = ve;
                          (Te = r.lencode[_e + ((d & ((1 << (pe + ke)) - 1)) >> pe)]),
                            (me = Te >>> 24),
                            (ge = (Te >>> 16) & 255),
                            (ve = 65535 & Te),
                            !(pe + me <= h);
                      ...
                      if (((d >>>= me), (h -= me), (r.back += me), (r.length = ve), 0 === ge)) {
                        r.mode = fe;
                        break;
                      }
                      if (32 & ge) {
                    ...
                    case ae:
                      ...
                      if (0 == (240 & ge)) {
                        for (
                          pe = me, ke = ge, _e = ve;
                          (Te = r.distcode[_e + ((d & ((1 << (pe + ke)) - 1)) >> pe)]),
                            (me = Te >>> 24),
                            (ge = (Te >>> 16) & 255),
                            (ve = 65535 & Te),
                            !(pe + me <= h);
                    ...
                    case se:
                      ...
                      if (((m = b - u), r.offset > m)) {
                        ...
                        (m > r.wnext ? ((m -= r.wnext), (g = r.wsize - m)) : (g = r.wnext - m),
                    ...
                    case ue:
                      if (r.wrap) {
                        ...
                        if (
                          ...
                          b &&
                            (e.adler = r.check =
                              r.flags ? k(r.check, a, b, s - b) : p(r.check, a, b, s - b)),
                          (b = u),
                ...
                return (
                  ...
                  (r.hold = d),
                  (r.bits = h),
                  (r.wsize || (b !== e.avail_out && r.mode < de && (r.mode < ue || t !== T))) &&
              ...
              function w(e, t) {
                var r;
                return e && e.state
                  ? ((r = e.state), 0 == (2 & r.wrap) ? U : ((r.head = t), (t.done = !1), A))
                  : U;
              }
              function b(e, t) {
                var r,
                ...
                return e && e.state
                  ? ((r = e.state),
                    0 !== r.wrap && r.mode !== Y
                      ? U
                      : r.mode === Y && ((n = 1), (n = p(n, t, i, 0)) !== r.check)
                        ? I
                        : l(e, t, i, i)
                          ? ((r.mode = he), Z)
                          : ((r.havedict = 1), A))
          ...
          9: [
            function (e, t, r) {
              ...
              t.exports = function (e, t, r, f, u, c, l, d) {
                ...
                for (S = 1; S < T && 0 === D[S]; S++);
                for (O < S && (O = S), C = 1, E = 1; E <= 15; E++)
                  if (((C <<= 1), (C -= D[E]) < 0)) return -1;
                if (C > 0 && (0 === e || 1 !== T)) return -1;
                for (N[1] = 0, E = 1; E < 15; E++) N[E + 1] = N[E] + D[E];
                for (x = 0; x < f; x++) 0 !== t[r + x] && (l[N[t[r + x]]++] = x);
                if (
                  (0 === e
                    ? ((I = z = l), (v = 19))
                    : 1 === e
                      ? ((I = i), (Z -= 257), (z = a), (P -= 257), (v = 256))
                      : ((I = o), (z = s), (v = -1)),
                  (U = 0),
                  (x = 0),
                  (E = S),
                ...
                for (;;) {
                  ((p = E - A),
                    ...
                    (S = w));
                  do {
                    ((w -= h), (u[g + (U >> A) + w] = (p << 24) | (k << 16) | _ | 0));
                  } while (0 !== w);
                  for (h = 1 << (E - 1); U & h; ) h >>= 1;
                  if ((0 !== h ? ((U &= h - 1), (U += h)) : (U = 0), x++, 0 == --D[E])) {
                    if (E === T) break;
                    E = t[r + l[x]];
                  }
                  if (E > O && (U & m) !== b) {
                    for (
                      0 === A && (A = O), g += S, B = E - A, C = 1 << B;
                      B + A < T && !((C -= D[B + A]) <= 0);
                    )
                      (B++, (C <<= 1));
                    if (((R += 1 << B), (1 === e && R > 852) || (2 === e && R > 592))) return 1;
                    ((b = U & m), (u[b] = (O << 24) | (B << 16) | (g - c) | 0));
                  }
                }
                return (0 !== U && (u[g + U] = ((E - A) << 24) | (64 << 16) | 0), (d.bits = O), 0);
              };
            },
            { '../utils/common': 1 },
          ],
            ...
            function (e, t, r) {
              ...
              ((n.prototype.push = function (e, t) {
                ...
                do {
                  if (
                    (0 === d.avail_out &&
                      ((d.output = new s.Buf8(w)), (d.next_out = 0), (d.avail_out = w)),
                    ...
                    r === u.Z_BUF_ERROR && !0 === m && ((r = u.Z_OK), (m = !1)),
                  ...
                  (d.next_out &&
                    ((0 !== d.avail_out &&
                      r !== u.Z_STREAM_END &&
                      (0 !== d.avail_in || (n !== u.Z_FINISH && n !== u.Z_SYNC_FLUSH))) ||
                ...
                return (
                  ...
                  n === u.Z_FINISH
                    ? ((r = o.inflateEnd(this.strm)),
                      ...
                      (this.ended = !0),
                      r === u.Z_OK)
                    : n !== u.Z_SYNC_FLUSH || (this.onEnd(u.Z_OK), (d.avail_out = 0), !0)
                );
              }),
    ...
    define(
      ...
      function (e, t, r) {
        ...
        function n(n) {
          ...
          return function (s) {
            var f = s.data;
            ((a.length = 0), (o.id = f.id), (o.error = void 0), (o.result = void 0));
            try {
    ...
    define(
      ...
      function (e, t, r, n, i) {
        ...
        function o(e, n, i) {
          ...
          if (((s += l), 1 !== d)) throw new r('Invalid data type. Must be 1 for QuadTreePacket');
          var w = o.getUint32(s, !0);
          if (((s += l), 2 !== w))
            throw new r('Invalid QuadTreePacket version. Only version 2 is supported.');
