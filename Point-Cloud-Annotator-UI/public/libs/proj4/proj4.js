!(function (t, s) {
  ...
  function s(t, s) {
    if (t[s]) return t[s];
    for (var i, a = Object.keys(t), h = s.toLowerCase().replace(Mt, ''), e = -1; ++e < a.length; )
      if (((i = a[e]), i.toLowerCase().replace(Mt, '') === h)) return t[i];
  }
  function i(s) {
    var a = this;
  ...
  function u(t, s, i, a) {
    var h = t * t,
      ...
      r = 0;
    return (
      a ? ((h = (t *= 1 - n * ($ + n * (tt + n * st))) * t), (n = 0)) : (r = Math.sqrt(n)),
      { es: n, e: r, ep2: (h - e) / e }
    );
  }
  ...
  function m(t, s, i, a, h, e) {
    ...
    return (
      ...
      s &&
        ...
        (0 === n.datum_params[0] && 0 === n.datum_params[1] && 0 === n.datum_params[2]) ||
          (n.datum_type = X),
    ...
    if ('object' == typeof a) {
      ...
      if (h) {
        ...
        var n = f(a.a, a.b, a.rf, a.ellps, a.sphere),
          ...
          o = a.datum || m(a.datumCode, a.datum_params, n.a, n.b, r.es, r.ep2);
        (mt(this, a),
          mt(this, h),
          (this.a = n.a),
          (this.b = n.b),
  ...
  function y(t, s, i) {
    ...
    return (
      ...
      (e = h * h),
      (a = i / Math.sqrt(1 - s * e)),
      { x: (a + l) * n * Math.cos(r), y: (a + l) * n * Math.sin(r), z: (a * (1 - s) + l) * h }
    );
  }
  function d(t, s, i, a) {
    var h,
    ...
    if (((h = Math.sqrt(v * v + g * g)), (e = Math.sqrt(v * v + g * g + b * b)), h / i < 1e-12)) {
      if (((d = 0), e / i < 1e-12)) return ((_ = Y), (x = -a), { x: t.x, y: t.y, z: t.z });
    } else d = Math.atan2(g, v);
    ((n = b / e),
      (c = (r = h / e) * (1 - s) * (o = 1 / Math.sqrt(1 - s * (2 - s) * r * r))),
      (u = n * o),
      (y = 0));
    do {
      (y++,
        ...
        (p =
          (m = n * (o = 1 / Math.sqrt(1 - l * (2 - l) * r * r))) * c - (f = r * (1 - l) * o) * u),
        (c = f),
        (u = m));
  ...
  function b(t, s) {
    return (
      ((t.datum.datum_type === X || t.datum.datum_type === H) && 'WGS84' !== s.datumCode) ||
      ((s.datum.datum_type === X || s.datum.datum_type === H) && 'WGS84' !== t.datumCode)
    );
  }
  function w(t, s, i) {
    var a;
    if (
      ...
      St(i),
      t.datum && s.datum && b(t, s) && ((i = w(t, (a = new Projection('WGS84')), i)), (t = a)),
      'enu' !== t.axis && (i = Nt(t, !1, i)),
      'longlat' === t.projName)
    )
      i = { x: i.x * at, y: i.y * at, z: i.z || 0 };
    else if (
      (t.to_meter && (i = { x: i.x * t.to_meter, y: i.y * t.to_meter, z: i.z || 0 }),
      !(i = t.inverse(i)))
    )
      return;
    return (
      ...
      s.from_greenwich && (i = { x: i.x - s.from_greenwich, y: i.y, z: i.z || 0 }),
      'longlat' === s.projName
        ? (i = { x: i.x * ht, y: i.y * ht, z: i.z || 0 })
        : ((i = s.forward(i)),
          s.to_meter && (i = { x: i.x / s.to_meter, y: i.y / s.to_meter, z: i.z || 0 })),
  ...
  function k(t, s, i) {
    ...
    return (
      void 0 === s
        ? ((s = t), (t = Ct), (h = !0))
        : (void 0 !== s.x || Array.isArray(s)) && ((i = s), (s = t), (t = Ct), (h = !0)),
      (s = P(s)),
      i
        ? A(t, s, i)
        : ((a = {
  ...
  function C(t) {
    ...
    var f =
        0.9996 *
          ...
          ((h = Math.cos(c) * (u - n)) +
            ((1 - i + a) * h * h * h) / 6 +
            ((5 - 18 * i + i * i + 72 * a - 0.39089081163157013) * h * h * h * h * h) / 120) +
        5e5,
      m =
        0.9996 *
        ((e =
          ...
          s *
            ...
            ((h * h) / 2 +
              ...
              ((61 - 58 * i + i * i + 600 * a - 2.2240339282485886) * h * h * h * h * h * h) /
                720));
    return (
      o < 0 && (m += 1e7),
      { northing: Math.round(m), easting: Math.round(f), zoneNumber: r, zoneLetter: R(o) }
    );
  }
  function I(t) {
    var s = t.northing,
    ...
    (a < 'N' && (y -= 1e7),
      ...
      (o = (0.99330562 * f) / Math.pow(1 - 0.00669438 * Math.sin(u) * Math.sin(u), 1.5)),
      (l = p / (0.9996 * e)));
    var d =
      u -
      ((e * Math.tan(u)) / o) *
        ((l * l) / 2 -
          ((5 + 3 * n + 10 * r - 4 * r * r - 0.06065547077041606) * l * l * l * l) / 24 +
          ((61 + 90 * n + 298 * r + 45 * n * n - 1.6983531815716497 - 3 * r * r) *
            l *
            l *
            l *
            l *
    ...
    var _ =
      (l -
        ((1 + 2 * n + r) * l * l * l) / 6 +
        ((5 - 2 * r + 28 * n - 3 * r * r + 0.05391597401814761 + 24 * n * n) * l * l * l * l * l) /
          120) /
      Math.cos(u);
    _ = M + S(_);
    var x;
  ...
  function z(t, s, i) {
    ...
    return (
      ...
      (n === Ot || (h < Ot && n > Ot) || ((n > Ot || h < Ot) && o)) && n++,
      (n === zt || (h < zt && n > zt) || ((n > zt || h < zt) && o)) && ++n === Ot && n++,
      n > Bt && (n = n - Bt + jt - 1),
      r > Lt ? ((r = r - Lt + jt - 1), (o = !0)) : (o = !1),
      (r === Ot || (e < Ot && r > Ot) || ((r > Ot || e < Ot) && o)) && r++,
      (r === zt || (e < zt && r > zt) || ((r > zt || e < zt) && o)) && ++r === Ot && r++,
      r > Lt && (r = r - Lt + jt - 1),
  ...
  function L(t) {
    ...
    var r = t.charAt(e++);
    if (r <= 'A' || 'B' === r || 'Y' === r || r >= 'Z' || 'I' === r || 'O' === r)
      throw 'MGRSPoint zone letter ' + r + ' not handled: ' + t;
    a = t.substring(e, (e += 2));
    for (var o = O(n), l = B(a.charAt(0), o), M = T(a.charAt(1), o); M < F(r); ) M += 2e6;
    var c = i - e;
    if (c % 2 != 0)
      throw (
    ...
    return (
      ...
      (p = _ + l),
      (y = x + M),
      { easting: p, northing: y, zoneLetter: r, zoneNumber: n, accuracy: u }
    );
  }
  function B(t, s) {
    for (var i = Rt.charCodeAt(s - 1), a = 1e5, h = !1; i !== t.charCodeAt(0); ) {
  ...
  function T(t, s) {
    ...
    for (var i = Gt.charCodeAt(s - 1), a = 0, h = !1; i !== t.charCodeAt(0); ) {
        ...
        : ((h = Math.atan2(s, i)),
          Math.abs(h) <= et
            ...
            : h > et && h <= Y + et
              ...
              : h > Y + et || h <= -(Y + et)
                ? ((a.value = Xs.AREA_2), (h = h >= 0 ? h - rt : h + rt))
  ...
  var lt = { ft: { to_meter: 0.3048 }, 'us-ft': { to_meter: 1200 / 3937 } },
    ...
    ct = function (t) {
      ...
      for (i in n)
        ((a = n[i]), i in r ? ('function' == typeof (h = r[i]) ? h(a) : (e[h] = a)) : (e[i] = a));
      return (
  ...
  var ut = [
    ...
    _t = function (t, s, i) {
      var a = t * i,
        h = 0.5 * t;
      return ((a = Math.pow((1 - a) / (1 + a), h)), Math.tan(0.5 * (Y - s)) / a);
    },
    xt = function (t, s) {
      for (var i, a, h = 0.5 * t, e = Y - 2 * Math.atan(s), n = 0; n <= 15; n++)
        if (
          ((i = t * Math.sin(e)),
          (a = Y - 2 * Math.atan(s * Math.pow((1 - i) / (1 + i), h)) - e),
          (e += a),
          Math.abs(a) <= 1e-10)
        )
          return e;
    ...
    vt = [
      {
          ...
          ((this.es = 1 - t * t),
            ...
            this.lat_ts
              ? this.sphere
                ...
                : (this.k0 = pt(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)))
              : this.k0 || (this.k ? (this.k0 = this.k) : (this.k0 = 1)));
        },
        forward: function (t) {
          var s = t.x,
            i = t.y;
          if (i * ht > 90 && i * ht < -90 && s * ht > 180 && s * ht < -180) return null;
          var a, h;
          if (Math.abs(Math.abs(i) - Y) <= it) return null;
          if (this.sphere)
            ((a = this.x0 + this.a * this.k0 * dt(s - this.long0)),
              (h = this.y0 + this.a * this.k0 * Math.log(Math.tan(et + 0.5 * i))));
          else {
            var e = Math.sin(i),
              n = _t(this.e, i, e);
            ((a = this.x0 + this.a * this.k0 * dt(s - this.long0)),
        ...
        inverse: function (t) {
          var s,
            ...
            a = t.x - this.x0,
            h = t.y - this.y0;
          if (this.sphere) i = Y - 2 * Math.atan(Math.exp(-h / (this.a * this.k0)));
          else {
            var e = Math.exp(-h / (this.a * this.k0));
            if (-9999 === (i = xt(this.e, e))) return null;
          }
          return ((s = dt(this.long0 + a / (this.a * this.k0))), (t.x = s), (t.y = i), t);
        },
        names: [
          'Mercator',
      ...
      { init: function () {}, forward: M, inverse: M, names: ['longlat', 'identity'] },
    ],
    gt = {},
    bt = [],
    wt = {
  ...
  ((At.MERIT = { a: 6378137, rf: 298.257, ellipseName: 'MERIT 1983' }),
    (At.SGS85 = { a: 6378136, rf: 298.257, ellipseName: 'Soviet Geodetic System 85' }),
    (At.GRS80 = { a: 6378137, rf: 298.257222101, ellipseName: 'GRS 1980(IUGG, 1980)' }),
    (At.IAU76 = { a: 6378140, rf: 298.257, ellipseName: 'IAU 1976' }),
    (At.airy = { a: 6377563.396, b: 6356256.91, ellipseName: 'Airy 1830' }),
    (At.APL4 = { a: 6378137, rf: 298.25, ellipseName: 'Appl. Physics. 1965' }),
    (At.NWL9D = { a: 6378145, rf: 298.25, ellipseName: 'Naval Weapons Lab., 1965' }),
    (At.mod_airy = { a: 6377340.189, b: 6356034.446, ellipseName: 'Modified Airy' }),
    (At.andrae = { a: 6377104.43, rf: 300, ellipseName: 'Andrae 1876 (Den., Iclnd.)' }),
    (At.aust_SA = { a: 6378160, rf: 298.25, ellipseName: 'Australian Natl & S. Amer. 1969' }),
    (At.GRS67 = { a: 6378160, rf: 298.247167427, ellipseName: 'GRS 67(IUGG 1967)' }),
    (At.bessel = { a: 6377397.155, rf: 299.1528128, ellipseName: 'Bessel 1841' }),
    (At.bess_nam = { a: 6377483.865, rf: 299.1528128, ellipseName: 'Bessel 1841 (Namibia)' }),
    (At.clrk66 = { a: 6378206.4, b: 6356583.8, ellipseName: 'Clarke 1866' }),
    (At.clrk80 = { a: 6378249.145, rf: 293.4663, ellipseName: 'Clarke 1880 mod.' }),
    (At.clrk58 = { a: 6378293.645208759, rf: 294.2606763692654, ellipseName: 'Clarke 1858' }),
    (At.CPM = { a: 6375738.7, rf: 334.29, ellipseName: 'Comm. des Poids et Mesures 1799' }),
    (At.delmbr = { a: 6376428, rf: 311.5, ellipseName: 'Delambre 1810 (Belgium)' }),
    (At.engelis = { a: 6378136.05, rf: 298.2566, ellipseName: 'Engelis 1985' }),
    (At.evrst30 = { a: 6377276.345, rf: 300.8017, ellipseName: 'Everest 1830' }),
    (At.evrst48 = { a: 6377304.063, rf: 300.8017, ellipseName: 'Everest 1948' }),
    (At.evrst56 = { a: 6377301.243, rf: 300.8017, ellipseName: 'Everest 1956' }),
    (At.evrst69 = { a: 6377295.664, rf: 300.8017, ellipseName: 'Everest 1969' }),
    (At.evrstSS = { a: 6377298.556, rf: 300.8017, ellipseName: 'Everest (Sabah & Sarawak)' }),
    (At.fschr60 = { a: 6378166, rf: 298.3, ellipseName: 'Fischer (Mercury Datum) 1960' }),
    ...
    (At.intl = { a: 6378388, rf: 297, ellipseName: 'International 1909 (Hayford)' }),
    ...
    (At.new_intl = { a: 6378157.5, b: 6356772.2, ellipseName: 'New International 1967' }),
    (At.plessis = { a: 6376523, rf: 6355863, ellipseName: 'Plessis 1817 (France)' }),
    (At.krass = { a: 6378245, rf: 298.3, ellipseName: 'Krassovsky, 1942' }),
    (At.SEasia = { a: 6378155, b: 6356773.3205, ellipseName: 'Southeast Asia' }),
  ...
  var Pt = (At.WGS84 = { a: 6378137, rf: 298.257223563, ellipseName: 'WGS 84' });
  At.sphere = { a: 6370997, b: 6370997, ellipseName: 'Normal Sphere (r=6370997)' };
  var kt = {};
  ((kt.wgs84 = { towgs84: '0,0,0', ellipse: 'WGS84', datumName: 'WGS84' }),
    (kt.ch1903 = { towgs84: '674.374,15.056,405.346', ellipse: 'bessel', datumName: 'swiss' }),
    (kt.ggrs87 = {
      towgs84: '-199.87,74.79,246.62',
      ellipse: 'GRS80',
      datumName: 'Greek_Geodetic_Reference_System_1987',
    }),
    (kt.nad83 = { towgs84: '0,0,0', ellipse: 'GRS80', datumName: 'North_American_Datum_1983' }),
    (kt.nad27 = {
    ...
    (kt.s_jtsk = { towgs84: '589,76,480', ellipse: 'bessel', datumName: 'S-JTSK (Ferro)' }),
    (kt.beduaram = { towgs84: '-106,-87,188', ellipse: 'clrk80', datumName: 'Beduaram' }),
    (kt.gunung_segara = {
      towgs84: '-403,684,41',
      ellipse: 'bessel',
  ...
  var qt = function (t, s, i) {
      return p(t, s)
        ...
        : t.datum_type === Z || s.datum_type === Z
          ? i
          : t.es !== s.es || t.a !== s.a || v(t.datum_type) || v(s.datum_type)
            ? ((i = y(i, t.es, t.a)),
              v(t.datum_type) && (i = _(i, t.datum_type, t.datum_params)),
              v(s.datum_type) && (i = x(i, s.datum_type, s.datum_params)),
              d(i, s.es, s.a, s.b))
            : i;
    },
    Nt = function (t, s, i) {
  ...
  var Ft = 0.01068115234375,
    Qt = function (t) {
      var s = [];
      ((s[0] = 1 - t * (0.25 + t * (0.046875 + t * (0.01953125 + t * Ft)))),
        (s[1] = t * (0.75 - t * (0.046875 + t * (0.01953125 + t * Ft)))));
      var i = t * t;
      return (
        (s[2] = i * (0.46875 - t * (0.013020833333333334 + 0.007120768229166667 * t))),
        (i *= t),
    ...
    Wt = function (t, s, i) {
      for (var a = 1 / (1 - s), h = t, e = 20; e; --e) {
        var n = Math.sin(h),
          r = 1 - s * n * n;
        if (
          ((r = (Dt(h, n, Math.cos(h), i) - t) * (r * Math.sqrt(r)) * a),
          (h -= r),
          Math.abs(r) < it)
        )
          return h;
    ...
    Ut = {
      init: function () {
        ((this.x0 = void 0 !== this.x0 ? this.x0 : 0),
          ...
          this.es &&
            ((this.en = Qt(this.es)),
            (this.ml0 = Dt(this.lat0, Math.sin(this.lat0), Math.cos(this.lat0), this.en))));
      },
      forward: function (t) {
        var s,
          i,
                          ...
                          (5 -
                            ...
                            (M / 30) *
                              (61 +
                                ...
                                270 * c -
                                330 * m * c +
                                (M / 56) * (1385 + 543 * p - p * m - 3111 * m)))))) +
              this.y0));
        } else {
          var d = o * Math.sin(n);
          if (Math.abs(Math.abs(d) - 1) < it) return 93;
          if (
            ((i = 0.5 * this.a * this.k0 * Math.log((1 + d) / (1 - d)) + this.x0),
      ...
      inverse: function (t) {
        ...
        if (this.es)
          if (((s = this.ml0 + n / this.k0), (i = Wt(s, this.es, this.en)), Math.abs(i) < Y)) {
            var r = Math.sin(i),
              o = Math.cos(i),
                    ...
                    (5 +
                      ...
                      (p / 30) *
                        (61 +
                          ...
                          45 * f +
                          46 * M -
                          (p / 56) * (1385 + 3633 * u + 4095 * f + 1574 * f * u))))),
              (h = dt(
                this.long0 +
                  (m *
                    (1 -
          ...
          var y = Math.exp(e / this.k0),
            ...
            x = Math.cos(_);
          ((s = Math.sqrt((1 - Math.pow(x, 2)) / (1 + Math.pow(d, 2)))),
            (a = Math.asin(s)),
            n < 0 && (a = -a),
            (h = 0 === d && 0 === x ? 0 : dt(Math.atan2(d, x) + this.long0)));
        }
    ...
    Zt = function (t, s) {
      for (var i, a = 2 * Math.cos(2 * s), h = t.length - 1, e = t[h], n = 0; --h >= 0; )
        ((i = a * e - n + t[h]), (n = e), (e = i));
    ...
    $t = function (t, s, i) {
      for (
        ...
        ((a = m), (h = f), (u = l * (m = u) - a - M * (f = p) + t[c]), (p = M * m - h + l * f));
    ...
    ts = {
      init: function () {
        ...
        var t = this.es / (1 + Math.sqrt(1 - this.es)),
          ...
          i = s;
        ((this.cgb[0] =
          s * (2 + s * (-2 / 3 + s * (s * (116 / 45 + s * (26 / 45 + s * (-2854 / 675))) - 2)))),
          (this.cbg[0] =
            s *
            (s * (2 / 3 + s * (4 / 3 + s * (-82 / 45 + s * (32 / 45 + s * (4642 / 4725))))) - 2)),
          (i *= s),
          (this.cgb[1] =
            i * (7 / 3 + s * (s * (-227 / 45 + s * (2704 / 315 + s * (2323 / 945))) - 1.6))),
          (this.cbg[1] =
            i * (5 / 3 + s * (-16 / 15 + s * (-13 / 9 + s * (904 / 315 + s * (-1522 / 945)))))),
          (i *= s),
          (this.cgb[2] = i * (56 / 15 + s * (-136 / 35 + s * (-1262 / 105 + s * (73814 / 2835))))),
          (this.cbg[2] = i * (-26 / 15 + s * (34 / 21 + s * (1.6 + s * (-12686 / 2835))))),
          (i *= s),
          (this.cgb[3] = i * (4279 / 630 + s * (-332 / 35 + s * (-399572 / 14175)))),
          ...
          (i = Math.pow(s, 2)),
          (this.Qn = (this.k0 / (1 + s)) * (1 + i * (0.25 + i * (1 / 64 + i / 256)))),
          (this.utg[0] =
            s *
            (s * (2 / 3 + s * (-37 / 96 + s * (1 / 360 + s * (81 / 512 + s * (-96199 / 604800))))) -
              0.5)),
          (this.gtu[0] =
            s *
            (0.5 +
              s *
                (-2 / 3 + s * (5 / 16 + s * (41 / 180 + s * (-127 / 288 + s * (7891 / 37800))))))),
          (this.utg[1] =
            i *
            (-1 / 48 +
              s * (-1 / 15 + s * (437 / 1440 + s * (-46 / 105 + s * (1118711 / 3870720)))))),
          (this.gtu[1] =
            i *
            (13 / 48 + s * (s * (557 / 1440 + s * (281 / 630 + s * (-1983433 / 1935360))) - 0.6))),
          (i *= s),
          (this.utg[2] = i * (-17 / 480 + s * (37 / 840 + s * (209 / 4480 + s * (-5569 / 90720))))),
          (this.gtu[2] =
            i * (61 / 240 + s * (-103 / 140 + s * (15061 / 26880 + s * (167603 / 181440))))),
          (i *= s),
          (this.utg[3] = i * (-4397 / 161280 + s * (11 / 504 + s * (830251 / 7257600)))),
          (this.gtu[3] = i * (49561 / 161280 + s * (-179 / 168 + s * (6601661 / 7257600)))),
          (i *= s),
      ...
      forward: function (t) {
        ...
        var a = Math.sin(i),
          ...
          e = Math.sin(s),
          n = Math.cos(s);
        ((i = Math.atan2(a, n * h)), (s = Math.atan2(e * h, Xt(a, h * n))), (s = Jt(Math.tan(s))));
    ...
    ss = function (t, s) {
      if (void 0 === t) {
        if ((t = Math.floor((30 * (dt(s) + Math.PI)) / Math.PI) + 1) < 0) return 0;
        if (t > 60) return 60;
      }
      return t;
    },
    ...
    es = {
      init: function () {
        ...
        ((s *= s),
          ...
          (this.K =
            ...
            (Math.pow(Math.tan(0.5 * this.lat0 + et), this.C) * as(this.e * t, this.ratexp))));
      },
      forward: function (t) {
        var s = t.x,
          i = t.y;
      ...
      inverse: function (t) {
        for (
          var s = t.x / this.C,
            i = t.y,
            a = Math.pow(Math.tan(0.5 * i + et) / this.K, 1 / this.C),
            h = hs;
          h > 0 &&
          ((i = 2 * Math.atan(a * as(this.e * Math.sin(t.y), -0.5 * this.e)) - Y),
    ...
    ns = {
      ...
      inverse: function (t) {
        ...
        return ((t.x = a), (t.y = h), es.inverse.apply(this, [t]), (t.x = dt(t.x + this.long0)), t);
      },
      names: [
    ...
    rs = {
        ...
        ((this.coslat0 = Math.cos(this.lat0)),
          ...
          this.sphere
            ? 1 === this.k0 &&
              ...
              (this.k0 = 0.5 * (1 + yt(this.lat0) * Math.sin(this.lat_ts)))
            : (Math.abs(this.coslat0) <= it && (this.lat0 > 0 ? (this.con = 1) : (this.con = -1)),
              (this.cons = Math.sqrt(
              ...
              1 === this.k0 &&
                ...
                Math.abs(this.coslat0) <= it &&
                (this.k0 =
                  (0.5 * this.cons * pt(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts))) /
                  _t(this.e, this.con * this.lat_ts, this.con * Math.sin(this.lat_ts))),
              (this.ms1 = pt(this.e, this.sinlat0, this.coslat0)),
              (this.X0 = 2 * Math.atan(this.ssfn_(this.lat0, this.sinlat0, this.e)) - Y),
      ...
      forward: function (t) {
        var s,
          ...
          M = Math.cos(o),
          c = dt(r - this.long0);
        return Math.abs(Math.abs(r - this.long0) - Math.PI) <= it && Math.abs(o + this.lat0) <= it
          ? ((t.x = NaN), (t.y = NaN), t)
          : this.sphere
            ? ((s = (2 * this.k0) / (1 + this.sinlat0 * l + this.coslat0 * M * Math.cos(c))),
              (t.x = this.a * s * M * Math.sin(c) + this.x0),
              (t.y = this.a * s * (this.coslat0 * l - this.sinlat0 * M * Math.cos(c)) + this.y0),
              t)
            : ((i = 2 * Math.atan(this.ssfn_(o, l, this.e)) - Y),
              ...
              Math.abs(this.coslat0) <= it
                ...
                : (Math.abs(this.sinlat0) < it
                    ? ((s = (2 * this.a * this.k0) / (1 + h * Math.cos(c))), (t.y = s * a))
                    : ((s =
                        (2 * this.a * this.k0 * this.ms1) /
                        (this.cosX0 * (1 + this.sinX0 * a + this.cosX0 * h * Math.cos(c)))),
                      (t.y = s * (this.cosX0 * a - this.sinX0 * h * Math.cos(c)) + this.y0)),
      ...
      inverse: function (t) {
        ...
        if (this.sphere) {
          ...
          return (
            ...
            n <= it
              ? ((t.x = s), (t.y = i), t)
              : ((i = Math.asin(
                  Math.cos(r) * this.sinlat0 + (t.y * Math.sin(r) * this.coslat0) / n,
                )),
                (s = dt(
                  Math.abs(this.coslat0) < it
                    ? this.lat0 > 0
                    ...
                    : this.long0 +
                        Math.atan2(
                          t.x * Math.sin(r),
                          n * this.coslat0 * Math.cos(r) - t.y * this.sinlat0 * Math.sin(r),
                        ),
                )),
                (t.x = s),
                (t.y = i),
        ...
        if (Math.abs(this.coslat0) <= it) {
          if (n <= it) return ((i = this.lat0), (s = this.long0), (t.x = s), (t.y = i), t);
          ((t.x *= this.con),
            (t.y *= this.con),
            (a = (n * this.cons) / (2 * this.a * this.k0)),
            (i = this.con * xt(this.e, a)),
            (s = this.con * dt(this.con * this.long0 + Math.atan2(t.x, -1 * t.y))));
        } else
          ((h = 2 * Math.atan((n * this.cosX0) / (2 * this.a * this.k0 * this.ms1))),
            (s = this.long0),
            n <= it
              ? (e = this.X0)
              : ((e = Math.asin(Math.cos(h) * this.sinX0 + (t.y * Math.sin(h) * this.cosX0) / n)),
                (s = dt(
                  this.long0 +
                    Math.atan2(
                      t.x * Math.sin(h),
                      n * this.cosX0 * Math.cos(h) - t.y * this.sinX0 * Math.sin(h),
                    ),
                ))),
      ...
      ssfn_: function (t, s, i) {
        return ((s *= i), Math.tan(0.5 * (Y + t)) * Math.pow((1 - s) / (1 + s), 0.5 * i));
      },
    },
    os = {
      init: function () {
        ...
        ((this.R = (this.k0 * i * Math.sqrt(1 - h)) / (1 - h * Math.pow(s, 2))),
          (this.alpha = Math.sqrt(1 + (h / (1 - h)) * Math.pow(Math.cos(t), 4))),
      ...
      forward: function (t) {
        var s = Math.log(Math.tan(Math.PI / 4 - t.y / 2)),
          ...
          n = Math.atan(
            Math.sin(e) / (Math.sin(this.b0) * Math.tan(h) + Math.cos(this.b0) * Math.cos(e)),
          ),
          r = Math.asin(
            Math.cos(this.b0) * Math.sin(h) - Math.sin(this.b0) * Math.cos(h) * Math.cos(e),
          );
        return (
          (t.y = (this.R / 2) * Math.log((1 + Math.sin(r)) / (1 - Math.sin(r))) + this.y0),
      ...
      inverse: function (t) {
        for (
          var s = t.x - this.x0,
            ...
            e = Math.asin(
              Math.cos(this.b0) * Math.sin(h) + Math.sin(this.b0) * Math.cos(h) * Math.cos(a),
            ),
            n = Math.atan(
              Math.sin(a) / (Math.cos(this.b0) * Math.cos(a) - Math.sin(this.b0) * Math.tan(h)),
            ),
          ...
          if (++c > 20) return;
          ((o =
            (1 / this.alpha) * (Math.log(Math.tan(Math.PI / 4 + e / 2)) - this.K) +
            this.e * Math.log(Math.tan(Math.PI / 4 + Math.asin(this.e * Math.sin(l)) / 2))),
            (M = l),
    ...
    ls = {
      init: function () {
        ...
        if (isNaN(this.longc)) {
          ...
          ((e = this.lat0 >= 0 ? h + Math.sqrt(h * h - 1) : h - Math.sqrt(h * h - 1)),
        ...
        this.no_off
          ...
          : this.lat0 >= 0
            ? (this.uc =
                (this.al / this.bl) * Math.atan2(Math.sqrt(h * h - 1), Math.cos(this.alpha)))
            : (this.uc =
                ((-1 * this.al) / this.bl) *
      ...
      forward: function (t) {
        ...
        if (Math.abs(Math.abs(e) - Y) <= it)
          ((a = e > 0 ? -1 : 1),
            (i = (this.al / this.bl) * Math.log(Math.tan(et + a * this.gamma0 * 0.5))),
        ...
        return (
          this.no_rot
            ...
            : ((s -= this.uc),
              (t.x = this.x0 + i * Math.cos(this.alpha) + s * Math.sin(this.alpha)),
              (t.y = this.y0 + s * Math.cos(this.alpha) - i * Math.sin(this.alpha))),
          t
        );
      },
      inverse: function (t) {
        ...
        this.no_rot
          ...
          : ((i = (t.x - this.x0) * Math.cos(this.alpha) - (t.y - this.y0) * Math.sin(this.alpha)),
            (s = (t.y - this.y0) * Math.cos(this.alpha) + (t.x - this.x0) * Math.sin(this.alpha)),
            (s += this.uc));
    ...
    Ms = {
      ...
      forward: function (t) {
        var s = t.x,
          i = t.y;
        Math.abs(2 * Math.abs(i) - Math.PI) <= it && (i = yt(i) * (Y - 2 * it));
        var a,
          h,
          e = Math.abs(Math.abs(i) - Y);
        if (e > it)
          ((a = _t(this.e, i, Math.sin(i))), (h = this.a * this.f0 * Math.pow(a, this.ns)));
        else {
      ...
      inverse: function (t) {
        ...
        return ((e = dt(o / this.ns + this.long0)), (t.x = e), (t.y = h), t);
      },
      names: [
    ...
    cs = {
      init: function () {
        ((this.a = 6377397.155),
          ...
          (this.k1 = this.k0),
          (this.n0 =
            (this.a * Math.sqrt(1 - this.e2)) / (1 - this.e2 * Math.pow(Math.sin(this.fi0), 2))),
      ...
      forward: function (t) {
        ...
        return (
          ...
          (i =
            2 *
            (Math.atan((this.k * Math.pow(Math.tan(l / 2 + this.s45), this.alfa)) / s) - this.s45)),
          (a = -M * this.alfa),
          (h = Math.asin(
            Math.cos(this.ad) * Math.sin(i) + Math.sin(this.ad) * Math.cos(i) * Math.cos(a),
          )),
      ...
      inverse: function (t) {
        ...
        ((t.x = t.y),
          ...
          (a =
            2 *
            (Math.atan(Math.pow(this.ro0 / e, 1 / this.n) * Math.tan(this.s0 / 2 + this.s45)) -
              this.s45)),
          (s = Math.asin(
            Math.cos(this.ad) * Math.sin(a) - Math.sin(this.ad) * Math.cos(a) * Math.cos(h),
          )),
    ...
    xs = function (t, s, i, a, h) {
      ...
      for (var r = 0; r < 15; r++)
        if (
          ((n =
            (t - (s * e - i * Math.sin(2 * e) + a * Math.sin(4 * e) - h * Math.sin(6 * e))) /
            (s - 2 * i * Math.cos(2 * e) + 4 * a * Math.cos(4 * e) - 6 * h * Math.cos(6 * e))),
          (e += n),
          Math.abs(n) <= 1e-10)
        )
          return e;
    ...
    vs = {
      init: function () {
        this.sphere ||
          ...
          (this.e2 = ps(this.es)),
          (this.e3 = ys(this.es)),
          (this.ml0 = this.a * us(this.e0, this.e1, this.e2, this.e3, this.lat0)));
      },
      forward: function (t) {
        var s,
          i,
      ...
      inverse: function (t) {
        ...
        if (this.sphere) {
          ...
          if (Math.abs(Math.abs(r) - Y) <= it)
            return ((t.x = this.long0), (t.y = Y), h < 0 && (t.y *= -1), t);
          var o = ds(this.a, this.e, Math.sin(r)),
            l = ((o * o * o) / this.a / this.a) * (1 - this.es),
            M = Math.pow(Math.tan(r), 2),
            c = (a * this.a) / o,
            u = c * c;
          ((s = r - ((o * Math.tan(r)) / l) * c * c * (0.5 - ((1 + 3 * M) * c * c) / 24)),
            (i = (c * (1 - u * (M / 3 + ((1 + 3 * M) * M * u) / 15))) / Math.cos(r)));
        }
    ...
    gs = function (t, s) {
      var i;
      return t > 1e-7
        ? ((i = t * s), (1 - t * t) * (s / (1 - i * i) - (0.5 / t) * Math.log((1 - i) / (1 + i))))
        : 2 * s;
    },
          ...
          switch (
            ...
            case this.OBLIQ:
              ((this.rq = Math.sqrt(0.5 * this.qp)),
                ...
                (this.dd =
                  Math.cos(this.lat0) / (Math.sqrt(1 - this.es * s * s) * this.rq * this.cosb1)),
      ...
      forward: function (t) {
        ...
        if (((c = dt(c - this.long0)), this.sphere)) {
          if (
            ...
            if (
              (i =
                this.mode === this.EQUIT ? 1 + M * a : 1 + this.sinph0 * e + this.cosph0 * M * a) <=
              it
            )
              return null;
            ((s = (i = Math.sqrt(2 / i)) * M * Math.sin(c)),
              (i *= this.mode === this.EQUIT ? e : this.cosph0 * e - this.sinph0 * M * a));
          } else if (this.mode === this.N_POLE || this.mode === this.S_POLE) {
            if ((this.mode === this.N_POLE && (a = -a), Math.abs(u + this.lat0) < it)) return null;
            ((i = et - 0.5 * u),
              (s = (i = 2 * (this.mode === this.S_POLE ? Math.cos(i) : Math.sin(i))) * Math.sin(c)),
              (i *= a));
          }
        } else {
          switch (
          ...
          switch (this.mode) {
            ...
            case this.S_POLE:
              n >= 0
                ? ((s = (l = Math.sqrt(n)) * h), (i = a * (this.mode === this.S_POLE ? l : -l)))
                : (s = i = 0);
          }
        }
      ...
      inverse: function (t) {
        ...
        if (this.sphere) {
          ...
          switch (
            ...
            case this.EQUIT:
              ((i = Math.abs(M) <= it ? 0 : Math.asin((l * u) / M)), (o *= u), (l = c * M));
              break;
            case this.OBLIQ:
              ((i =
                Math.abs(M) <= it
          ...
          if (((r = 0), this.mode === this.OBLIQ || this.mode === this.EQUIT)) {
            if (((o /= this.dd), (l *= this.dd), (n = Math.sqrt(o * o + l * l)) < it))
    ...
    Cs = {
      ...
      forward: function (t) {
        ...
        return (
          ...
          (i = Math.cos(l)),
          (h = Math.cos(a)),
          (e = this.sin_p14 * s + this.cos_p14 * i * h) > 0 || Math.abs(e) <= it
            ? ((n = this.x0 + (1 * this.a * i * Math.sin(a)) / e),
              (r = this.y0 + (1 * this.a * (this.cos_p14 * s - this.sin_p14 * i * h)) / e))
            : ((n = this.x0 + this.infinity_dist * i * Math.sin(a)),
              (r = this.y0 + this.infinity_dist * (this.cos_p14 * s - this.sin_p14 * i * h))),
          (t.x = n),
          (t.y = r),
          t
        );
        ...
        return (
          ...
          (s = Math.sqrt(t.x * t.x + t.y * t.y))
            ? ((h = Math.atan2(s, this.rc)),
              (i = Math.sin(h)),
              (a = Math.cos(h)),
              (n = Es(a * this.sin_p14 + (t.y * i * this.cos_p14) / s)),
              (e = Math.atan2(t.x * i, s * this.cos_p14 * a - t.y * this.sin_p14 * i)),
              (e = dt(this.long0 + e)))
            : ((n = this.phic0), (e = 0)),
          (t.x = e),
          (t.y = n),
      ...
      for (var a, h, e, n, r = Math.asin(0.5 * s), o = 0; o < 30; o++)
        if (
          ...
          (a =
            ...
            (s / (1 - t * t) - h / (1 - n * n) + (0.5 / t) * Math.log((1 - n) / (1 + n)))),
          (r += a),
          Math.abs(a) <= 1e-10)
        )
          return r;
    ...
    Rs = {
      init: function () {
        this.sphere || (this.k0 = pt(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)));
      },
      forward: function (t) {
        var s,
          i,
        ...
        if (this.sphere)
          ...
          ((s = this.x0 + this.a * this.k0 * e), (i = this.y0 + (this.a * n * 0.5) / this.k0));
        }
        return ((t.x = s), (t.y = i), t);
      },
      inverse: function (t) {
        ...
        return (
          this.sphere
            ? ((s = dt(this.long0 + t.x / this.a / Math.cos(this.lat_ts))),
    ...
    Os = {
        ...
        if (((a = n * Math.sin(e)), this.sphere))
          Math.abs(e) <= it
            ...
            : ((s = (this.a * Math.sin(a)) / Math.tan(e)),
              (i = this.a * (_s(e - this.lat0) + (1 - Math.cos(a)) / Math.tan(e))));
        else if (Math.abs(e) <= it) ((s = this.a * n), (i = -1 * this.ml0));
        else {
      ...
      inverse: function (t) {
        ...
        if (((a = t.x - this.x0), (h = t.y - this.y0), this.sphere))
          if (Math.abs(h + this.a * this.lat0) <= it) ((s = dt(a / this.a + this.long0)), (i = 0));
          else {
            ...
            for (e = js; e; --e)
              if (
                ((M = Math.tan(o)),
                (l = (-1 * (n * (o * M + 1) - o - 0.5 * (o * o + r) * M)) / ((o - n) / M - 1)),
                (o += l),
                Math.abs(l) <= it)
              ) {
                i = o;
            ...
            s = dt(this.long0 + Math.asin((a * Math.tan(o)) / this.a) / Math.sin(i));
          }
        else if (Math.abs(h + this.ml0) <= it) ((i = 0), (s = dt(this.long0 + a / this.a)));
        else {
          ...
          for (e = js; e; --e)
            if (
              ...
              (u = this.a * us(this.e0, this.e1, this.e2, this.e3, o)),
              (f =
                this.e0 -
              ...
              (l =
                ...
                ((this.es * Math.sin(2 * o) * (m * m + r - 2 * n * m)) / (4 * c) +
          ...
          ((c = Math.sqrt(1 - this.es * Math.pow(Math.sin(i), 2)) * Math.tan(i)),
            (s = dt(this.long0 + Math.asin((a * c) / this.a) / Math.sin(i))));
        }
        return ((t.x = s), (t.y = i), t);
      },
        ...
        for (var u = 0; u < this.iterations; u++) {
          ...
          for (s = 2; s <= 6; s++)
            ((f = p * M + m * c),
              (m = m * M - p * c),
              (p = f),
              (y += (s - 1) * (this.B_re[s] * m - this.B_im[s] * p)),
              (d += (s - 1) * (this.B_im[s] * m + this.B_re[s] * p)));
          ((m = 1), (p = 0));
          var _ = this.B_re[1],
            x = this.B_im[1];
          for (s = 2; s <= 6; s++)
          ...
          this.sphere
            ...
            : ((s = Wt(t.y / this.a, this.es, this.en)),
              (h = Math.abs(s)) < Y
                ? ((h = Math.sin(s)),
                  (i =
                    this.long0 + (t.x * Math.sqrt(1 - this.es * h * h)) / (this.a * Math.cos(s))),
                  (a = dt(i)))
                : h - it < Y && (a = this.long0)),
          (t.x = a),
          (t.y = s),
    ...
    Fs = {
      init: function () {},
      forward: function (t) {
        for (var s = t.x, i = t.y, a = dt(s - this.long0), h = i, e = Math.PI * Math.sin(i); ; ) {
      ...
      inverse: function (t) {
        ...
        ((t.x -= this.x0),
          ...
          (s = Math.asin(i)));
        var a = dt(this.long0 + t.x / (0.900316316158 * this.a * Math.cos(s)));
        (a < -Math.PI && (a = -Math.PI),
          a > Math.PI && (a = Math.PI),
    ...
    Ds = {
      ...
      forward: function (t) {
        var s,
          ...
          h = t.y,
          e = dt(a - this.long0);
        Math.abs(h) <= it && ((s = this.x0 + this.R * e), (i = this.y0));
        ...
        var r = 0.5 * Math.abs(Math.PI / e - e / Math.PI),
          ...
          p =
            (Math.PI *
              this.R *
              (r * (c - m) + Math.sqrt(o * (c - m) * (c - m) - (m + o) * (u - m)))) /
            (m + o);
        (e < 0 && (p = -p), (s = this.x0 + p));
        var y = o + c;
        return (
          (p = (Math.PI * this.R * (f * y - r * Math.sqrt((m + o) * (o + 1) - y * y))) / (m + o)),
      ...
      inverse: function (t) {
        ...
        return (
          ...
          (r = n - 2 * h * h + a * a),
          (o = -2 * n + 1 + 2 * h * h + e * e),
          (f = (h * h) / o + ((2 * r * r * r) / o / o / o - (9 * n * r) / o / o) / 27),
          (l = (n - (r * r) / 3 / o) / o),
          (M = 2 * Math.sqrt(-l / 3)),
          (c = (3 * f) / l / M),
          ...
          (s =
            Math.abs(a) < it
              ...
              : dt(
                  this.long0 +
                    (Math.PI * (e - 1 + Math.sqrt(1 + 2 * (a * a - h * h) + e * e))) / 2 / a,
                )),
          (t.x = s),
          (t.y = i),
          t
    ...
    Ws = {
          ...
          ? Math.abs(this.sin_p12 - 1) <= it
            ...
            : Math.abs(this.sin_p12 + 1) <= it
              ? ((t.x = this.x0 + this.a * (Y + P) * Math.sin(N)),
                (t.y = this.y0 + this.a * (Y + P) * Math.cos(N)),
                t)
              : ((_ = this.sin_p12 * k + this.cos_p12 * q * Math.cos(N)),
                (y = Math.acos(_)),
                (d = y ? y / Math.sin(y) : 1),
                (t.x = this.x0 + this.a * d * q * Math.sin(N)),
                (t.y = this.y0 + this.a * d * (this.cos_p12 * k - this.sin_p12 * q * Math.cos(N))),
                t)
          : ((s = fs(this.es)),
            (i = ms(this.es)),
            (a = ps(this.es)),
            ...
            Math.abs(this.sin_p12 - 1) <= it
              ...
              : Math.abs(this.sin_p12 + 1) <= it
                ...
                : ((r = k / q),
                  ...
                  (M = Math.atan((1 - this.es) * r + (this.es * o * this.sin_p12) / (l * q))),
                  (c = Math.atan2(
                    Math.sin(N),
      ...
      inverse: function (t) {
        ((t.x -= this.x0), (t.y -= this.y0));
        var s, i, a, h, e, n, r, o, l, M, c, u, f, m, p, y, d, _, x, v, g, b, w, A;
        if (this.sphere) {
          if ((s = Math.sqrt(t.x * t.x + t.y * t.y)) > 2 * Y * this.a) return;
          return (
            (i = s / this.a),
            (a = Math.sin(i)),
            (h = Math.cos(i)),
            ...
            Math.abs(s) <= it
              ? (n = this.lat0)
              : ((n = Es(h * this.sin_p12 + (t.y * a * this.cos_p12) / s)),
                ...
                (e = dt(
                  Math.abs(r) <= it
                    ? this.lat0 >= 0
                      ...
                      : this.long0 - Math.atan2(-t.x, t.y)
                    : this.long0 +
                        Math.atan2(t.x * a, s * this.cos_p12 * h - t.y * this.sin_p12 * a),
                ))),
            (t.x = e),
            (t.y = n),
            t
          ...
          Math.abs(this.sin_p12 - 1) <= it
            ...
            : Math.abs(this.sin_p12 + 1) <= it
              ...
              : ((s = Math.sqrt(t.x * t.x + t.y * t.y)),
                ...
                (x = (-_ * _) / (1 - this.es)),
                (v = (3 * this.es * (1 - x) * this.sin_p12 * this.cos_p12 * d) / (1 - this.es)),
                (g = s / m),
                (b =
                  g - (x * (1 + x) * Math.pow(g, 3)) / 6 - (v * (1 + 3 * x) * Math.pow(g, 4)) / 24),
                (w = 1 - (x * b * b) / 2 - (g * b * b * b) / 6),
                (p = Math.asin(this.sin_p12 * Math.cos(b) + this.cos_p12 * Math.sin(b) * d)),
                (e = dt(this.long0 + Math.asin((Math.sin(y) * Math.sin(b)) / Math.cos(p)))),
                (A = Math.sin(p)),
                (n = Math.atan2((A - this.es * w * this.sin_p12) * Math.tan(p), A * (1 - this.es))),
                (t.x = e),
                (t.y = n),
                t)
        );
      ...
      forward: function (t) {
        ...
        return (
          ...
          ((e = this.sin_p14 * s + this.cos_p14 * i * h) > 0 || Math.abs(e) <= it) &&
            ...
            (r = this.y0 + 1 * this.a * (this.cos_p14 * s - this.sin_p14 * i * h))),
          (t.x = n),
          (t.y = r),
          t
        );
      ...
      inverse: function (t) {
        ...
        return (
          ...
          Math.abs(s) <= it
            ...
            : ((r = Es(h * this.sin_p14 + (t.y * a * this.cos_p14) / s)),
              ...
              Math.abs(e) <= it
                ? ((n = dt(
                  ...
                  t)
                : ((n = dt(
                    this.long0 + Math.atan2(t.x * a, s * this.cos_p14 * h - t.y * this.sin_p14 * a),
                  )),
                  (t.x = n),
                  (t.y = r),
                  t))
    ...
    Hs = {
            ...
            : this.lat0 <= -(Y - et / 2)
              ...
              : Math.abs(this.long0) <= et
                ...
                : Math.abs(this.long0) <= Y + et
                  ? (this.face = this.long0 > 0 ? Ks.RIGHT : Ks.LEFT)
                  : (this.face = Ks.BACK),
          0 !== this.es &&
      ...
      forward: function (t) {
        ...
        if (
          ((t.x -= this.long0),
          (s = 0 !== this.es ? Math.atan(this.one_minus_f_squared * Math.tan(t.y)) : t.y),
          (i = t.x),
          this.face === Ks.TOP)
        )
          ((h = Y - s),
            i >= et && i <= Y + et
              ...
              : i > Y + et || i <= -(Y + et)
                ? ((o.value = Xs.AREA_1), (a = i > 0 ? i - rt : i + rt))
                : i > -(Y + et) && i <= -et
          ...
          ((h = Y + s),
            i >= et && i <= Y + et
              ...
              : i < et && i >= -et
                ...
                : i < -et && i >= -(Y + et)
                  ? ((o.value = Xs.AREA_2), (a = -i - Y))
                  : ((o.value = Xs.AREA_3), (a = i > 0 ? -i + rt : -i - rt)));
        else {
          var l, M, c, u, f, m;
          (this.face === Ks.RIGHT
            ? (i = U(i, +Y))
        ...
        return (
          (n = Math.atan((12 / rt) * (a + Math.acos(Math.sin(a) * Math.cos(et)) - Y))),
          (e = Math.sqrt(
            (1 - Math.cos(h)) /
      ...
      inverse: function (t) {
        ...
        if (
          ...
          t.x >= 0 && t.x >= Math.abs(t.y)
            ...
            : t.y >= 0 && t.y >= Math.abs(t.x)
              ...
              : t.x < 0 && -t.x >= Math.abs(t.y)
                ? ((c.value = Xs.AREA_2), (s = s < 0 ? s + rt : s - rt))
          ...
          (a = Math.cos(s)),
          (h = Math.tan(i)),
          (r = 1 - a * a * h * h * (1 - Math.cos(Math.atan(1 / Math.cos(n))))) < -1
            ? (r = -1)
            : r > 1 && (r = 1),
          this.face === Ks.TOP)
        )
          ...
          ((l = (u = r) * u),
            ...
            c.value === Xs.AREA_1
              ...
              : c.value === Xs.AREA_2
                ? ((f = -f), (m = -m))
                : c.value === Xs.AREA_3 && ((l = f), (f = m), (m = -l)),
            this.face === Ks.RIGHT
              ? ((l = u), (u = -f), (f = l))
              : this.face === Ks.BACK
                ? ((u = -u), (f = -f))
                : this.face === Ks.LEFT && ((l = u), (u = f), (f = -l)),
            (M.phi = Math.acos(-m) - Y),
        ...
        if (0 !== this.es) {
          ...
          ((p = M.phi < 0 ? 1 : 0),
            (y = Math.tan(M.phi)),
            (d = this.b / Math.sqrt(y * y + this.one_minus_f_squared)),
            (M.phi = Math.atan(Math.sqrt(this.a * this.a - d * d) / (this.one_minus_f * d))),
            p && (M.phi = -M.phi));
        }
    ...
    hi = {
      ...
      forward: function (t) {
        var s = dt(t.x - this.long0),
          i = Math.abs(t.y),
          a = Math.floor(i * $s);
        (a < 0 ? (a = 0) : a >= si && (a = si - 1), (i = ht * (i - ti * a)));
      ...
      inverse: function (t) {
        var s = { x: (t.x - this.x0) / (this.a * Vs), y: Math.abs(t.y - this.y0) / (this.a * Ys) };
