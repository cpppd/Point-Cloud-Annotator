    ...
    f = {
      ...
      addClass: function (a, d) {
        if (void 0 === a.className) a.className = d;
          ...
          -1 == b.indexOf(d) &&
            (b.push(d), (a.className = b.join(' ').replace(/^\s+/, '').replace(/\s+$/, '')));
        }
        return f;
      },
...
dat.controllers.NumberControllerBox = (function (e, a, b) {
  var d = function (f, c, e) {
    ...
    a.bind(this.__input, 'keydown', function (a) {
      13 === a.keyCode &&
        ((n.__truncationSuspended = !0), this.blur(), (n.__truncationSuspended = !1));
    });
    this.updateDisplay();
...
dat.color.toString = (function (e) {
  return function (a) {
    ...
    return (
      'rgba(' + Math.round(a.r) + ',' + Math.round(a.g) + ',' + Math.round(a.b) + ',' + a.a + ')'
    );
  };
})(dat.utils.common);
...
dat.GUI = dat.gui.GUI = (function (e, a, b, d, f, c, p, k, l, q, n, r, y, g, h) {
    ...
    h.extend(b, {
      options: function (d) {
        ...
        if (h.isArray(d) || h.isObject(d))
          return (
            b.remove(),
            t(a, b.object, b.property, { before: b.__li.nextElementSibling, factoryArgs: [d] })
          );
      },
      name: function (a) {
    ...
    onResize: function () {
      ...
      if (a.scrollable) {
        ...
        window.innerHeight - b - 20 < d
          ...
          : (g.removeClass(a.domElement, m.CLASS_TOO_TALL), (a.__ul.style.height = 'auto'));
      }
      a.__resize_handle &&
        h.defer(function () {
  ...
  (dat.controllers.factory = (function (e, a, b, d, f, c, p) {
    return function (k, l, q, n) {
      ...
      if (p.isNumber(r))
        return p.isNumber(q) && p.isNumber(n) ? new b(k, l, q, n) : new a(k, l, { min: q, max: n });
  ...
  (dat.controllers.ColorController = (function (e, a, b, d, f) {
    function c(a, b, d, c) {
      ...
      f.each(l, function (e) {
        a.style.cssText +=
          'background: ' + e + 'linear-gradient(' + b + ', ' + d + ' 0%, ' + c + ' 100%); ';
      });
    }
    function p(a) {
      a.style.background = '';
    ...
    (dat.color.Color = (function (e, a, b, d) {
      ...
      function p(b, c, e) {
        if ('HEX' === b.__state.space) b.__state[c] = a.component_from_hex(b.__state.hex, e);
